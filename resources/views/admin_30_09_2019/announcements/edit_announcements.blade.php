                        ...
                        @endif
							...
							<div class="form-group ">
								...
								<div class="input-daterange input-group" id="date-range">
									<input type="text" class="form-control"  name="start_date" id="start_date" value="{{ $announcements_detail[0]->start_date }}" readonly="true" />
									<span class="input-group-addon bg-info b-0 text-white">to</span>
									<input type="text" class="form-control" name="end_date" id="end_date" value="{{ $announcements_detail[0]->end_date }}" readonly="true" />
								</div>
							</div>							
