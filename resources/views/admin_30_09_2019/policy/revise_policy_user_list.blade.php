        ...
        <div class="white-box">                
            ...
            <div class="table-responsive">
                <table id="policy_table" class="table table-striped">
                    ...
                    <tbody>
                    @if(count($policyImageList)>0)
                    @foreach($policyImageList as $img)
                    <tr>
                    <?php
                    $url     = url('/storage/app/'.$img);
                    $Imgpath = str_replace("public/","",$url);
                    ?>
                    <td>
                        <a onclick='openPolicy("<?php echo $Imgpath; ?>")' href='#' data-toggle='modal' data-target='#galleryModal'> <img src="{{ $Imgpath }}" height="100px;" width="200px;">
                        </a>
                    </td>
                    </tr>
                    @endforeach
