            ...
            {"taregts": 6,
                    "render": function (data, type, row) {
                        ...
                        if($.inArray('2',access_rule) !== -1){
                            ...
                            out += '<a href="<?php echo url('change_bank_status') ?>'+'/'+id+'/Disabled'+'" class="btn btn-success" title="Change Status">'+row.status+'</a>';
                            }
                            else{
                            out += '<a href="<?php echo url('change_bank_status') ?>'+'/'+id+'/Enabled'+'" class="btn btn-danger" title="Change Status">'+row.status+'</a>';    
                            }
                        }
                        return out;
                    }
