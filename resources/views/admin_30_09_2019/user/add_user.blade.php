                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <input type="file"  id="input-file-now" accept="image/x-png, image/jpg, image/jpeg" name="exp_document[]" class="dropify" />
...
<script>
    ...
    function add_new_experience() {
        ...
        var append_html = '<div id="experience_div' + new_total_count + '">' +
                ...
                '<div class="form-group ">' +
                '<label>Upload Document(Only JPG, JPEG and PNG)</label>' +
                '<input type="file" accept="image/x-png, image/jpg, image/jpeg" name="exp_document[]" id="exp_document' + new_total_count + '" class="dropify" />' +
                '</div>' +
                '</div>' +
                '</div>' +
                '<hr class="m-t-0 m-b-40"></div>';
