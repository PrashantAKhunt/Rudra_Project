                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="m-t-20">
                            ...
                            <form action="{{ route('admin.insertroles') }}" method="post" id="rolefrm">
                                @csrf
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row"> 
                                                ...
                                                <div class="form-group border">
                                                    <label class="col-sm-3 control-label">Role Name&nbsp;<label class="serror">*</label> </label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" name="role_name" id="role_name" value="" style="margin-bottom: 12px;">
                                                    </div>
                                                    <div class="col-sm-4">
                                                    ...
                                                    <div class="col-xs-12">
                                                        <table class="table table-bordered text-center">
                                                            <tr>
                                                                ...
                                                                <td colspan="<?php echo (($index + 1) * $step < $count) ? $step : ($count - ($index * $step)) ?>"><b>Function</b></td>
                                                            </tr>
                                                            ...
                                                            foreach ($Roles as $key => $val) {
                                                                ...
                                                                <tr class="noBlank">
                                                                    ...
                                                                    for ($i = $iterator; $i < ($iterator + $step) && $i < $count; $i++) {
                                                                        ...
                                                                        ?>
                                                                        <td>
                                                                            <?php if (in_array($key, $actions_list)) { ?>
                                                                                <div class="ckbox ckbox-default checkbox-center">
                                                                                    <input id="action_<?php echo $module[$i]['id'] . '_' . $key ?>" type="checkbox" name="permissions[<?php echo $module[$i]['id'] ?>][<?php echo $key ?>]" class="action-checkbox" 
                                        ...
                                        <div class="panel-footer">
                                            <div class="row">
                                                <div class="col-sm-9 col-sm-offset-3">
                                                    ...
                                                    <button type="reset" class="btn btn-default" onclick="window.location.href = '{{ route('admin.roles') }}'">Cancel</button>
                                                </div>
                                            </div>
                                        </div><!-- panel-footer -->  
                                    </div><!-- panel -->
