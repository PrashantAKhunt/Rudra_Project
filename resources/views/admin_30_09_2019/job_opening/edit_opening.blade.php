                    ...
                    <div class="col-sm-6 col-xs-6">
                        ...
                        <form action="{{ route('admin.update_job_opening') }}" id="job_opening_frm" method="post">
                            ...
                            <div class="form-group "> 
                                ...
                                <input type="text" class="form-control" name="description" id="description"  value="{{ $job_opening[0]->description }}" />
                            </div>
                            ...
                            <div class="form-group "> 
                                ...
                                <select class="form-control" name="type" id="type">
                                    ...
                                    <option <?php echo ($job_opening[0]->type==$job_opening[0]->type)?"selected='selected'":'' ?> value="FullTime">Full Time</option>
                                    <option <?php echo ($job_opening[0]->type==$job_opening[0]->type)?"selected='selected'":'' ?> value="PartTime">Part Time</option>
                                    <option <?php echo ($job_opening[0]->type==$job_opening[0]->type)?"selected='selected'":'' ?> value="Remote">Remote</option>
                                </select>
                            </div>
