                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="#" class="waves-effect"><i class="icon-credit-card fa-fw" data-icon="v"></i> <span class="hide-menu">Finance<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li><a href="{{ route('admin.travel') }}"><i class="fa fa fa-plane"></i> Travel Expense</a></li>
                                @endif

                                @if(Auth::user()->role==config('constants.SuperUser') || Auth::user()->role==config('constants.Admin') || Auth::user()->role==config('constants.ACCOUNT_ROLE') ||
                                Auth::user()->role==config('constants.ASSISTANT'))
                                <li><a href="{{ route('admin.all_travel') }}"><i class="fa fa-plane"></i> Approve Travel Expense</a></li>
                                @endif
...
//$get_salary_slip_partial_view_permission= Permissions::checkPermission(19,6);
                        ...
                        <li><a href="#" class="waves-effect"><i class="fa fa-paper-plane" data-icon="v"></i> <span class="hide-menu">Letter-head Management<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li> <a href="{{ route('admin.pre_sign_letter') }}" class="waves-effect"><i class="fa fa-pencil fa-fw"></i> <span class="hide-menu">Pre-signed Letter-head Request</span></a> </li>
                                @endif
                                ...
                                <li> <a href="{{ route('admin.pro_sign_letter') }}" class="waves-effect"><i class="fa fa-pencil fa-fw"></i> <span class="hide-menu">Letter-head Request</span></a> </li>
                                @endif

                                @if(Auth::user()->role==config('constants.SuperUser') || Auth::user()->role==config('constants.ASSISTANT'))
                                <li> <a href="{{ route('admin.pre_sign_letter_list') }}" class="waves-effect"><i class="icon-briefcase"></i> <span class="hide-menu">Approve Pre-signed Letter-head Request</span></a> </li>
                                @endif

                                @if(Auth::user()->role==config('constants.ASSISTANT'))
                                <li> <a href="{{ route('admin.pro_sign_letter_list') }}" class="waves-effect"><i class="icon-briefcase"></i> <span class="hide-menu">Approve Letter-head Request</span></a> </li>
                                @endif
