...
.sidebar-nav{
    ...
    <body class="fix-sidebar">
        ...
        <li class="dropdown"> <a @if(Route::currentRouteName()=='admin.dashboard') style="padding-top:18px !important;" @endif  class="dropdown-toggle waves-effect waves-light" href="{{ route('admin.chat') }}"><i class="icon-envelope"></i>
          @if($offline_message_count>0)
                <div @if(Route::currentRouteName()=='admin.dashboard') style="margin-top:-9px !important;" @endif class="notify"><span class="heartbit"></span><span class="point"></span></div>
          @endif
            </a>
                ...
                <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                    ...
                    <ul class="nav" id="side-menu">
						...
						<li> <a href="#" class="waves-effect"><i class="fa fa-gears" data-icon="v"></i> <span class="hide-menu">General<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <?php
                                $vendor_full_view_permission = Permissions::checkPermission(63, 5);
                                ?>
                                ...
                                <li> <a href="{{ route('admin.get_device_user') }}" class="waves-effect"><i class="fa fa-ban fa-fw"></i> <span class="hide-menu">Device Allow</span></a> </li>
                                @endif
                                ...
                                {{-- TDS Section Type --}}
                                <?php
                                $section_permission = Permissions::checkSpecialPermission(77);
                                ?>
                                @if($section_permission)
                                <li> <a href="{{route('admin.tds_section')}}" class="waves-effect"><i class="fa fa-file-text-o" aria-hidden="true"></i> <span class="hide-menu">TDS Section Type</span></a> </li>
                                @endif
                               ...
                               <!--  @if($setting_my_view_permission)
                                ...
                                @endif -->
                                @if(Auth::user()->role==config('constants.SuperUser') || Auth::user()->role==config('constants.Admin'))
                                <li> <a href="{{ route('admin.add_special_permission') }}" class="waves-effect"><i class="fa  fa-key"></i> <span class="hide-menu">Special Module Permission</span></a> </li>
                                @endif
                                 <!-- Here -->
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
							<li> <a href="{{ route('admin.holiday_work_attendance') }}" class="waves-effect"><i data-icon="a" class="fa fa-clock-o"></i> <span class="hide-menu">Holiday Working Request</span></a> </li>
							@if(Auth::user()->role==config('constants.REAL_HR') || Auth::user()->role==config('constants.SuperUser'))
							<li> <a href="{{ route('admin.work_off_all_attendance_history') }}" class="waves-effect"><i data-icon="a" class="fa fa-clock-o"></i> <span class="hide-menu">Holiday Working Request Approval</span></a> </li>
							@endif
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                @if(Auth::user()->role != config('constants.SuperUser') && Auth::user()->role!=config('constants.Admin'))
                                <li> <a href="{{ route('admin.your_hold_budget_sheet_list') }}" class="waves-effect"><i class="fa fa-file-excel-o"></i> <span class="hide-menu">Your Hold Budget Sheet</span></a> </li>
                                @endif
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="#" class="waves-effect"><i class="fa fa-bank " data-icon="v"></i> 
                                <span class="hide-menu">Cash Management<span class="fa arrow"></span></span>
                            </a>
                            <ul class="nav nav-second-level">
                                 @if(Auth::user()->role==config('constants.SuperUser') || Auth::user()->role==config('constants.Admin'))
                                <li> <a href="{{ route('admin.company_cash_management') }}" class="waves-effect"><i data-icon="a" class="fa fa-file"></i> <span class="hide-menu">Company Cash</span></a> </li>

                                <li> <a href="{{ route('admin.employee_cash_management') }}" class="waves-effect"><i data-icon="a" class="fa fa-file"></i> <span class="hide-menu">Employee Cash</span></a> </li>

                                <li> <a href="{{ route('admin.cash_transfer_list') }}" class="waves-effect"><i data-icon="a" class="fa fa-file"></i> <span class="hide-menu">Cash Transaction</span></a> </li>
                                @endif
                                
                                <li> <a href="{{ route('admin.add_employee_cash_transfer') }}" class="waves-effect"><i data-icon="a" class="fa fa-file"></i> <span class="hide-menu">Employee Cash Transfer</span></a> </li>
                        ...
                        <li><a href="#" class="waves-effect"><i class="fa fa-university" aria-hidden="true"></i> <span class="hide-menu">Cheque Management<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li> <a href="{{ route('admin.signed_cheque_list') }}" class="waves-effect"><i class="fa fa-credit-card-alt fa-fw"></i> <span class="hide-menu">Cheque Signature Request</span></a> </li>
                                ...
                                <li> <a href="{{ route('admin.cancel_cheque_list') }}" class="waves-effect"><i class="fa fa-credit-card-alt fa-fw"></i> <span class="hide-menu">Stop Payment</span></a> </li>
                            </ul>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="#" class="waves-effect"><i class="fa fa-file" data-icon="v"></i> 
                                <span class="hide-menu">Company Softcopy<span class="fa arrow"></span></span>
                            </a>
                            <ul class="nav nav-second-level">
                            	@if(Auth::user()->role==config('constants.Admin'))
                            		<li> <a href="{{ route('admin.softcopy_document_category') }}" class="waves-effect"><i data-icon="a" class="fa fa-file"></i> <span class="hide-menu">Softcopy Document category</span></a> </li>
                            	@endif
                                    <li> <a href="{{ route('admin.softcopy_request_sent') }}" class="waves-effect"><i data-icon="a" class="fa fa-file"></i> <span class="hide-menu">Sent Softcopy Request</span></a> </li>
                                    <li> <a href="{{ route('admin.softcopy_request_received') }}" class="waves-effect"><i data-icon="a" class="fa fa-file"></i> <span class="hide-menu">Received Softcopy Request</span></a> </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="#" class="waves-effect"><i class="fa fa-clock-o" data-icon="v"></i> 
                                <span class="hide-menu">Compliance Reminder<span class="fa arrow"></span></span>
                            </a>
                            <ul class="nav nav-second-level">
                                <li> <a href="{{ route('admin.compliance_category') }}" class="waves-effect"><i data-icon="a" class="fa fa-file"></i> <span class="hide-menu">Compliance Category</span></a> </li>

                                <li> <a href="{{ route('admin.compliance_reminders') }}" class="waves-effect"><i data-icon="a" class="fa fa-file"></i> <span class="hide-menu">Compliance Reminder</span></a> </li>

                                <li> <a href="{{ route('admin.complience_reminder_list') }}" class="waves-effect"><i data-icon="a" class="fa fa-file"></i> <span class="hide-menu">Compliance Reminder List</span></a> </li>
                        ...
                        <li><a href="#" class="waves-effect"><i class="icon-handbag fa-fw" data-icon="v"></i> <span class="hide-menu">Driver Expense<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                $driver_ids = $common_task->get_vehicle_asset_driver();
                        ...
                        <li><a href="#" class="waves-effect"><i class="icon-handbag fa-fw" data-icon="v"></i> <span class="hide-menu">Leave<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                ?>
                                <!-- new module added for leave reversal start -->
                                
                                @if(Auth::user()->role==config('constants.SuperUser') || Auth::user()->role==config('constants.REAL_HR'))
                                <li><a href="{{ route('admin.leave_reversal') }}"><i class="ti-wallet"></i> Leave Reversal</a></li>
                                @endif
                                <!-- new module added for leave reversal end -->
                        ...
                        <li><a href="#" class="waves-effect"><i class="fa fa-paper-plane" data-icon="v"></i> <span class="hide-menu">Letter-head Management<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                @if(Auth::user()->role==config('constants.LETTERHEAD_APPROVE') || Auth::user()->role==config('constants.SuperUser'))
                                ...
                                @endif
                                @if(Auth::user()->role==config('constants.SuperUser') || Auth::user()->role==config('constants.REAL_HR') || Auth::user()->role==config('constants.ACCOUNT_ROLE') || Auth::user()->role==config('constants.Admin') || Auth::user()->role==config('constants.ADMIN_EXECUTIVE'))
                                <hr>
                        ...
                        <li><a href="#" class="waves-effect"><i class="fa fa-usd fa-fw" data-icon="v"></i> <span class="hide-menu">Payment<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li> <a href="{{ route('admin.tender_payment_request_list') }}" class="waves-effect"><i class="fa fa-university fa-fw"></i> <span class="hide-menu">Tender Bank Payment Request</span></a> </li>
                                @endif
                            </ul>
                        </li>
                        ...
                        <li><a href="#" class="waves-effect"><i class="ti-announcement fa-fw" data-icon="v"></i> <span class="hide-menu">Policy<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li> <a href="{{ route('admin.company_rules') }}" class="waves-effect"><i class="icon-emotsmile fa-fw"></i> <span class="hide-menu">Company Rules</span></a> </li>
					...
					<li> <a href="{{ route('admin.rtgs_use_report') }}" class="waves-effect"><i class="fa fa-file-excel-o"></i> <span class="hide-menu">RTGS Use Report</span></a> </li>
                       ...
                       <!--  <li><a href="#" class="waves-effect"><i class="fa fa-university" aria-hidden="true"></i> <span class="hide-menu">Cheque Management<span class="fa arrow"></span></span></a>
                        ...
                        ?>
                        <li><a href="#" class="waves-effect"><i class="fa fa-pencil" data-icon="v"></i> <span class="hide-menu">Stationery Management<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                @if(Auth::user()->role==config('constants.SuperUser') || Auth::user()->role==config('constants.Admin'))
                                    <li> <a href="{{ route('admin.add_inventory_managers') }}" class="waves-effect"> <i class="icon-people fa-fw" data-icon="v"></i> <span class="hide-menu">Inventory User Setting</span></a> </li>
                                @endif
                                @if(Auth::user()->role==config('constants.SuperUser') || 
                                    Auth::user()->role==config('constants.Admin') || 
                                    Auth::user()->role==config('constants.REAL_HR') || 
                                    Auth::user()->id == $invemtory_manager ||
                                    Auth::user()->id == $purchase_manager)
                                <li><a href="{{ route('admin.stationary_items') }}"><i class="ti-pencil"></i> Stationery Items</a></li>
                                <li><a href="{{ route('admin.inventory_stock_requests') }}"><i class="ti-alert"></i> Inventory Stocks</a></li>
                                @endif
                                <li><a href="{{ route('admin.stationery_access_requests') }}"><i class="ti-alert"></i> Stationery Item Access Request</a></li>
                            </ul>
                        </li>
                         <!-- new stationary module -->
                        ...
                        <?php
                        $voucher_add_view_permission = Permissions::checkPermission(62, 3);
                        $voucher_full_view_permission = Permissions::checkPermission(62, 5);
                        ?>
                        <li> <a href="#" class="waves-effect"><i class="fa fa-file" data-icon="v"></i> <span class="hide-menu">Voucher Book Management<span class="fa arrow"></span></span></a>
                            <ul class="nav nav-second-level">
                                @if(Auth::user()->role==config('constants.SuperUser') || Auth::user()->role==config('constants.REAL_HR') || Auth::user()->role==config('constants.ACCOUNT_ROLE') ||
                                Auth::user()->role==config('constants.Admin'))
                                <li> <a href="{{route('admin.voucher_number_book')}}" class="waves-effect"><i class="fa fa-file"></i> <span class="hide-menu">Blank Voucher Book</span></a> </li>
                                @endif
                                @if(Auth::user()->role==config('constants.SuperUser') || Auth::user()->role==config('constants.REAL_HR') || Auth::user()->role==config('constants.ACCOUNT_ROLE'))
                                <li> <a href="{{route('admin.used_voucher_number')}}" class="waves-effect"><i class="fa fa-file"></i> <span class="hide-menu">Used Voucher Number</span></a> </li>
                                @endif
                                @if($voucher_full_view_permission)
                                <li> <a href="{{route('admin.assign_voucher_number')}}" class="waves-effect"><i class="fa fa-file"></i> <span class="hide-menu">Assign Voucher Book</span></a> </li>
                                @endif
                                @if(Auth::user()->role==config('constants.SuperUser') || Auth::user()->role==config('constants.REAL_HR') || Auth::user()->role==config('constants.ACCOUNT_ROLE'))
                                <li> <a href="{{route('admin.failed_voucher_number')}}" class="waves-effect"><i class="fa fa-file"></i> <span class="hide-menu">Failed Voucher Number</span></a> </li>
                                @endif
                            </ul>
                        </li>
                        <!-- new bloc added DOCUMENT SIGNATURE Start -->
