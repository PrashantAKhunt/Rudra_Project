                ...
                {"taregts": 1,
                    "render": function (data, type, row) {
                        if(row.name==null) {
                           ...
                           var url=  "<?php echo url('/storage/');?>"+"/"+row.name;
                           return "<a onclick=openPolicy('"+url.replace("public/","")+"','"+row.id+"') href='#' data-toggle='modal' data-target='#galleryModal'>Open Policy</a>";
                        }
                    }
                },
                {"taregts": 2, "searchable": false, "data": "implementation_date"},
                {"taregts": 3, "searchable": false, "data": "amendment_date"},
                {"taregts": 4, "searchable": false, "data": "addendum_date"},
                {"taregts": 5, "searchable": false, "data": "effective_from"},
