            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        @endif
                        <form action="{{ route('admin.insert_rule') }}" id="add_rule" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group "> 
                                <label>Company Rule <span class="error">*</span> </label> 
                                <textarea class="form-control"  name="rule_name" id="rule_name" cols="30" rows="10" value="" /></textarea>
                            </div>
