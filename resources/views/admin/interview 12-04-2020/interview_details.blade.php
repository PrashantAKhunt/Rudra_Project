...
<div class="container-fluid">
    ...
    <?php if((Auth::user()->role == config('constants.SuperUser')) && $interview_details->emp_status == 'completed'){ ?>
        <div class="row">            
            <div class="col-sm-1">
    ...
    <?php } ?>
        ...
        <hr>
    <?php     
        $counter = $totalMarks = 0; foreach ($interview_result as $key => $interview) { $counter++; 
