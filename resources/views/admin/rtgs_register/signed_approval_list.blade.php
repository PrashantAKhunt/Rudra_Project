                ...
                <div class="table-responsive">
                    <table id="approval_table" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$data->rtgs_ref_no}}</td>
                                <td>{{$data->rtgs_start_no}}</td>
                                <td>{{$data->rtgs_end_no}}</td>
                                <td>{{$data->name}}</td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a href="#" title="Accept" onclick="accept_confirm(this);" data-href="{{ route('admin.accept_approval_rtgs_ref',['id'=>$data->id]) }}" class="btn btn-success btn-rounded"> <i class="fa fa-check"></i></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content" id="model_data">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{ route('admin.reject_approval_rtgs_ref') }}" id="add_delivery">
                            @csrf
                            <div class="row">
                                <div class="col-xs-12">

                                    <label for="reject_note">Reject note</label>
                                    <input type="hidden" name="rtgs_id" id="rtgs_id" value="">
