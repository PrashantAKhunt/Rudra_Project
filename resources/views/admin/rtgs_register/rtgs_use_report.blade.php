            ...
            <div class="panel panel-info">
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <form action="{{ route('admin.rtgs_use_report') }}" id="rtgs_frm" method="post" class="form-material" accept-charset="utf-8">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-6">
        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <table id="rtgsused_table" class="table table-striped">
                        <thead>
                            <tr>
                                <th>Company</th>
                                <th>Bank</th>
