            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        @endif
                        <form action="{{ route('admin.insert_rtgs_neft_register') }}" id="add_cheque" method="post">
                            @csrf
                            ...
                            <button type="button" onclick="window.location.href ='{{ route('admin.rtgs_neft_register') }}'" class="btn btn-default">Cancel</button>
                        </form>
                    </div>
                </div>
            </div>
