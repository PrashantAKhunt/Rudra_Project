    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            <div class="white-box">
                ...
                <a href="{{ route('admin.add_general_register') }}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add General Register</a>
        ...
        <script>
            $(document).ready(function () {
                ...
                var table = $('#company_table').DataTable({
                    ...
                    stateSave: true,
                    "ajax": {
                        url: "<?php echo route('admin.get_general_register_list'); ?>",
                        type: "GET",
                    },
                    "columns": [
