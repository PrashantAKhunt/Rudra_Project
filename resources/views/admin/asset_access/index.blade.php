            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.update_asset_access') }}" id="update_asset_access" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group "> 
                            <label>Access Date <span class="error">*</span> </label> 
        ...
        "columns": [
            ...
            {"taregts": 5,
                "render": function (data, type, row) {
                    ...
                    let app_date = '';
                    if(row.receiver_datetime){
                        app_date = moment(row.receiver_datetime).format("DD-MM-YYYY hh:ss A");
                    }
                    if (row.status == "Assigned" && row.hr_status == "Confirmed" && row.receiver_status == "Pending" && row.asset_access_user_id == loggedin_user) {
