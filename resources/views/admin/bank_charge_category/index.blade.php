    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            @if($view_special_permission)
                <a href="{{ route('admin.add_bank_charge_category') }}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add</a>
            @endif
        ...
        <script>
            $(document).ready(function () {
                ...
                var table = $('#bank_charge_table').DataTable({
                    ...
                    "order": [[3, "DESC"]],
                    "ajax": {
                        url: "<?php echo route('admin.get_bank_charge_table_list'); ?>",
                        type: "GET",
                    },
                    "columns": [
                        ...
                        {"taregts": 3, "searchable": false, "orderable": false,
                            "render": function (data, type, row) {
                                ...
                                var out="";
                                if (check_permission) {
                                    out = '<a href="<?php echo url('edit_bank_charge_category') ?>'+'/'+id+'" title="Edit Bank Category" class="btn btn-primary btn-rounded"><i class="fa fa-edit"></i></a>';
                                }
                                return out;
                            }
                        },
