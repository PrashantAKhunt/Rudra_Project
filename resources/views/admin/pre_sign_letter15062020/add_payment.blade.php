...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Add Pre Sign Details</h4>
        </div>
            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        @endif
                        <form action="{{ route('admin.insert_pre_sign_letter') }}" id="insert_pre_sign_letter" method="post" enctype="multipart/form-data">
                            @csrf
...
@section('script')
<script>
    jQuery('#insert_pre_sign_letter').validate({
        ignore: [],
        rules: {
            title: {
                required: true,
