                            ...
                            <tr>
                                ...
                                <td>
                                    @if($report->invoice_file)
                                                @php
                                                    $images =  str_replace('public/','',$report->invoice_file);
                                                @endphp
                                                <a href="{{asset('/storage/' . $images)}}" title="Download" download><i class="fa fa-cloud-download fa-lg"></i></a>
                                            @endif
                                </td>
                                <td>
                                    ...
                                    <b class="text-success">
                                        {{ $report->first_approval_status }} <br>
                                        @if($report->first_approval_datetime)
                                        {{ date('d-m-Y  h:i a', strtotime($report->first_approval_datetime)) }}
                                        @endif
                                    </b>
                                ...
                                <td>
                                    ...
                                    <b class="text-success">
                                        ...
                                        @if($report->second_approval_datetime)
                                        {{ date('d-m-Y  h:i a', strtotime($report->second_approval_datetime)) }}
                                        @endif
                                ...
                                <td>
                                    ...
                                    <span class="text-success">{{ $report->status }} @else</span>
