            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        @endif
                        <form action="{{ route('admin.release_hold_amount') }}" id="hold_budget_sheet_frm" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <br>
                            <hr class="m-t-0">
                            <h3 class="page-title">Complete Hold Amount Form</h3>
                            <hr class="m-t-0">
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">Remain Hold Amount</label>
                                        <input class="form-control" type="text" id="remain_hold_amount" name="remain_hold_amount" value="{{ $budget_data[0]->remain_hold_amount }}" readonly/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">Release Hold Amount</label>
                                        <input class="form-control" type="text" id="release_hold_amount" name="release_hold_amount" max="{{ $budget_data[0]->remain_hold_amount }}" />
                                        <input class="form-control" type="hidden" name="budget_sheet_id" value="{{ $budget_sheet_id }}" />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
