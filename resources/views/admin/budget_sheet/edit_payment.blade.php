                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="mode_of_payment" id="mode_of_payment" class="form-control">
                                                    ...
                                                    <option @if($budget_sheet_detail[0]->mode_of_payment=='Credit Card') selected @endif value="Credit Card">Credit Card</option>
                                                    <option @if($budget_sheet_detail[0]->mode_of_payment=='Debit Card') selected @endif value="Debit Card">Debit Card</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" onchange="get_project_list();"  required id="client_id" name="client_id">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select class="form-control" onchange="get_project_list();" required name="project_type" id="project_type">
                                        <option value="">Select Project Status</option>
                                        <option @if($budget_sheet_detail[0]->project_type=='Current') selected @endif value="Current">Current</option>
                                        <option @if($budget_sheet_detail[0]->project_type=='Completed') selected @endif value="Completed">Completed</option>
                                    </select>
                                </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control purchase_order_number" type="text" id="purchase_order_number" name="purchase_order_number" value="{{ $budget_sheet_detail[0]->purchase_order_number }}"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">Purchase Order Date</label>
                                        <input class="form-control purchase_order_date" type="text" id="purchase_order_date" name="purchase_order_date" value="{{ $budget_sheet_detail[0]->purchase_order_date }}"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control bill_number" type="text" id="bill_number" name="bill_number" value="{{ $budget_sheet_detail[0]->bill_number }}"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control bill_date" type="text" id="bill_date" name="bill_date" value="{{ $budget_sheet_detail[0]->bill_date }}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<script>
    ...
    project_type = "<?php echo $budget_sheet_detail[0]->project_type; ?>";
        $.ajax({
...
function get_project_list() {
    if ($("#client_id").val() > 0) {
        ...
        $.ajax({
            ...
            data: {
                client_id: $("#client_id").val(),project_type:$("#project_type").val()
            },
            dataType: "JSON",
            success: function(data) {
    ...
    jQuery('#update_budget_sheet').validate({
        ...
        rules: {
            ...
            purchase_order_number : {
                    ...
                    "id" : $( "#id" ).val(),
                    "_token": "{{csrf_token()}}",
                    purchase_order_number: function() {
                        return $( "#purchase_order_number" ).val();
                    }
                    }
                }
            },
            bill_number : {
                    ...
                    "id" : $( "#id" ).val(),
                    "_token": "{{csrf_token()}}",
                    bill_number: function() {
                        return $( "#bill_number" ).val();
                    }
                    }
                }
            }
        ...
        messages : {
            purchase_order_number: {
                remote : "Purchase order number exits use another."
            },
            bill_number: {
                remote : "Bill number exits use another."
            },
