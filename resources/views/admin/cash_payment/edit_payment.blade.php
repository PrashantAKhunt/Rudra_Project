                        ...
                        <form action="{{ route('admin.update_cash_payment') }}" id="update_cash_payment" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group ">
                                ...
                                <option value="">Select Project Status</option>
                                    <option @if($cash_payment_detail[0]->project_type=='Current') selected @endif value="Current">Current</option>
                                    <option @if($cash_payment_detail[0]->project_type=='Completed') selected @endif value="Completed">Completed</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group ">
                                <label>Amount</label>
                                <input type="textarea" class="form-control" name="amount" id="amount" value="{{$cash_payment_detail[0]->amount - $cash_payment_detail[0]->igst_amount - $cash_payment_detail[0]->cgst_amount - $cash_payment_detail[0]->sgst_amount}}" />
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" name="vender_invoice_no" id="vender_invoice_no" value="{{ $cash_payment_detail[0]->vender_invoice_no }}" />
                            </div>
                            <div class="form-group ">
                                <label>IGST Amount</label>
                                <input type="number" class="form-control" name="igst_amount" id="igst_amount" value="{{ ($cash_payment_detail[0]->igst_amount) ? $cash_payment_detail[0]->igst_amount : 0 }}" />
                            </div>
                            <div class="form-group ">
                                <label>CGST Amount</label>
                                <input type="number" class="form-control" name="cgst_amount" id="cgst_amount" value="{{ ($cash_payment_detail[0]->cgst_amount) ? $cash_payment_detail[0]->cgst_amount : 0 }}" />
                            </div>
                            <div class="form-group ">
                                <label>SGST Amount</label>
                                <input type="number" class="form-control" name="sgst_amount" id="sgst_amount" value="{{ ($cash_payment_detail[0]->sgst_amount) ? $cash_payment_detail[0]->sgst_amount : 0 }}" />
                            </div>
                            <div class="form-group ">
...
<script>
    ...
    $(document).ready(function () {
        ...
        project_type = "<?php echo $cash_payment_detail[0]->project_type; ?>";
