    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            <div class="white-box">                
                ...
                if (in_array(3, $role)) {
                    ?>
                    <a href="{{ route('admin.add_pre_sign_letter_detail') }}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Sign Letter Head Request</a>
                <?php } ?>
        ...
        <script>
            $(document).ready(function () {
                ...
                var table = $('#policy_table').DataTable({
                    ...
                    stateSave: true,
                    "ajax": {
                        url: "<?php echo route('admin.get_pre_sign_letter_list'); ?>",
                        type: "GET",
                    },
                    "columns": [
                        ...
                        {"taregts": 11, "searchable": false, "orderable": false, "render": function (data, type, row) {
                        ...
                        {"taregts": 12, "searchable": false, "orderable": false,
                            "render": function (data, type, row) {
                                ...
                                if (($.inArray('2', access_rule) !== -1)) {
                                    out += '&nbsp;<a href="<?php echo url("edit_pre_sign_letter_detail") ?>' + '/' + id + '" class="btn btn-primary btn-rounded"><i class="fa fa-edit"></i></a>';
                                }
                                // if (($.inArray('2',access_rule) !== -1)) {
