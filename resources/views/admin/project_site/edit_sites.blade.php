            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form action="{{ route('admin.update_project_sites') }}" enctype="multipart/form-data" id="add_site_frm" method="post">
                            @csrf
                            <input type="hidden" name="id" id="id" value="{{ $project_site_list[0]->id }}" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="company_id" id="companies_list" required>
                                            ...
                                            <option @if($value->id==$project_site_list[0]->company_id) selected @endif value="{{$value['id']}}">{{$value['company_name']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control" name="client_id" id="clients_list" required>
                                            <option value="" disabled selected>Please Select client</option>
                                            @foreach($clients as  $value)
                                            <option @if($value->id==$project_site_list[0]->client_id) selected @endif value="{{$value['id']}}">{{$value['client_name'].'-'.$value['location']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control" name="project_id" id="projects_list" required>
                                            ...
                                            <option @if($value->id==$project_site_list[0]->project_id) selected @endif value="{{$value['id']}}">{{$value['project_name']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="site_name" id="site_name" value="{{ $project_site_list[0]->site_name }}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="site_address" id="site_address" value="{{ $project_site_list[0]->site_address }}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <textarea class="form-control" name="site_details" id="site_details">{{ $project_site_list[0]->site_details }}</textarea>
                                    </div>
                                </div>
                            </div>
        ...
        $('#add_site_frm').validate({
            rules: {
                ...
                site_name: {
                    required: true,
                    remote: {
                        url: "{{ route('admin.checkEditProjectSiteName') }}",
                        type: "post",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            "name": function () {
            ...
            messages: {
                site_name: {
                    remote: "Site name is already exists for this project."
                }
            }
        })
...
<script>
    ...
    $("#clients_list").change(function () {
        ...
        let project_id = <?php echo json_encode($project_site_list[0]->project_id); ?>;
