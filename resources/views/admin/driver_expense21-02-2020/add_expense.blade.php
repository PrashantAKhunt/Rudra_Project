                ...
                <div class="row">                    
                    ...
                    <form action="{{ route('admin.insert_expense') }}" enctype="multipart/form-data" id="add_expense" method="post">
                        ...
                        <div class="col-sm-6 col-xs-6">
                           ...
                           <!--  <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div> 
                                    <input type="file" name="meter_reading_photo" class="form-control" id="meter_reading_photo" accept="image/x-png, image/jpg, image/jpeg" data-accept="jpg,png,jpeg"/>
                                </div>
                            </div>  
                            <div class="form-group ">
                        ...
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <div class="form-group ">
                                <label>Meter Reading<span id="last_reading"> (Last Reading:-0)</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <div> 
                                    <input type="file" name="bill_photo" class="form-control" id="bill_photo" accept="image/png, image/jpg, image/jpeg" data-accept="jpg,png,jpeg"/>
                                </div>
                            </div>                        
                        </div>
                        <div class="col-md-12">
