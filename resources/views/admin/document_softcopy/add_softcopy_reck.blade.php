    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route($reck_module_link) }}">{{ $module_title }} Rack</a></li>
            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        @endif
                        <form action="{{ route('admin.insert_hardcopy_reck') }}" id="add_softcopy_reck" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                <label>Cupboard <span class="error">*</span> </label>
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" name="reck_number" id="reck_number" value="" />
                            </div>
                            <div class="form-group ">
...
<script>
	var __dayDiff = 0;
    jQuery('#add_softcopy_reck').validate({
        ignore: [],
        rules: {
            company_id: {
                required: true,
