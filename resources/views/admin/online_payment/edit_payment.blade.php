                        ...
                        <form action="{{ route('admin.update_online_payment') }}" id="update_payment" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group ">
                                ...
                                <select class="form-control" onchange="get_budget_sheet();" name="payment_options" id="payment_options">
                                        ...
                                        <option <?php if ($online_payment_detail[0]->payment_options == "Budget Sheet") { ?> selected <?php } ?> value="Budget Sheet">Budget Sheet</option>
                                        <option <?php if ($online_payment_detail[0]->payment_options == "Emergency Option") { ?> selected <?php } ?> value="Emergency Option">Emergency Option</option>
                                        <option <?php if ($online_payment_detail[0]->payment_options == "Regular") { ?> selected <?php } ?> value="Regular">Regular</option>
                            ...
                            <div class="form-group " id="entry_code_div">
                                ...
                                <select class="form-control" onchange="get_payment_data();" name="entry_code" id="entry_code">
                                    ...
                                    <option value="{{ $main_entry }}" <?php echo ($online_payment_detail[0]->entry_code == $main_entry) ? "selected='selected'" : '' ?>>{{ $main_entry }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                ...
                                <option value="">Select Project Status</option>
                                    <option @if($online_payment_detail[0]->project_type=='Current') selected @endif value="Current">Current</option>
                                    <option @if($online_payment_detail[0]->project_type=='Completed') selected @endif value="Completed">Completed</option>
                                </select>
                            </div>
                            ...
                            <input type="text" class="form-control" name="total_amount" id="total_amount" readonly value="{{$online_payment_detail[0]->total_amount}}" />
                            </div>
                            <div class="form-group ">
                                <label>Part Payment Amount (If not part payment then add amount same as above)</label>
                                <input type="textarea" class="form-control" name="amount" id="amount" value="<?php echo $online_payment_detail[0]->amount - $online_payment_detail[0]->igst_amount - $online_payment_detail[0]->cgst_amount - $online_payment_detail[0]->sgst_amount + $online_payment_detail[0]->tds_amount; ?>" />
                            </div>
                            <div class="form-group ">
                                <label>IGST Amount</label>
                                <input type="number" class="form-control" name="igst_amount" id="igst_amount" value="{{($online_payment_detail[0]->igst_amount) ? $online_payment_detail[0]->igst_amount : 0}}" />
                            </div>
                            <div class="form-group ">
                                <label>CGST Amount</label>
                                <input type="number" class="form-control" name="cgst_amount" id="cgst_amount" value="{{($online_payment_detail[0]->cgst_amount) ? $online_payment_detail[0]->cgst_amount : 0}}" />
                            </div>
                            <div class="form-group ">
                                <label>SGST Amount</label>
                                <input type="number" class="form-control" name="sgst_amount" id="sgst_amount" value="{{($online_payment_detail[0]->sgst_amount) ? $online_payment_detail[0]->sgst_amount : 0}}" />
                            </div>
                            <div class="form-group ">
                                ...
                                <select name="section_type_id" id="section_type_id" class="form-control">
                                    ...
                                    @if (count($section_type))
                                        @foreach ($section_type as $key => $value)
                                            <option value="{{$value['id']}}" @if($value['id'] == $online_payment_detail[0]->section_type_id) selected @endif>{{$value['section_type']}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                            <div class="form-group ">
                                ...
                                <input type="number" class="form-control" name="tds_amount" id="tds_amount" value="{{($online_payment_detail[0]->tds_amount) ? $online_payment_detail[0]->tds_amount : 0}}" />
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group invoice_no_part" style="display: none;">
                                ...
                                <input type="text" name="invoice_no" id="invoice_no" class="form-control" value="<?php echo $online_payment_detail[0]->invoice_no; ?>"/>
                            </div>
                            <div class="form-group invoice_no_part" style="display: none;">
                            ...
                            <div class="form-group ">
                                <label>Payment Amount : </label><span id="payment_amount" class="text-success"><?php echo $online_payment_detail[0]->amount - $online_payment_detail[0]->igst_amount - $online_payment_detail[0]->cgst_amount - $online_payment_detail[0]->sgst_amount + $online_payment_detail[0]->tds_amount; ?></span>
                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        let check_entry = <?php echo $online_payment_detail[0]->main_entry; ?>;
        if (check_entry == 0) {
            ...
            // $("#entry_code_div").hide();
            $('#entry_code_div').attr("style", "display: none;");
        }
        ...
        var check_val = "<?php echo $online_payment_detail[0]->payment_options; ?>";
        if (check_val == 'Budget Sheet') {
            $('#budget_sheet').show();
        $.ajax({
                url: "{{ route('admin.getBudgetSheets') }}",
                ...
                success: function(data) {
                    ...
                    $("#budget_sheet_id").val("<?php echo $online_payment_detail[0]->budget_sheet_id; ?>").trigger('change.select2');
                }
            });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#client_id").val("<?php echo $online_payment_detail[0]->client_id; ?>").trigger('change.select2');
            }
        });

        //----------------------------------------Project:
        client_id = "<?php echo $online_payment_detail[0]->client_id; ?>";
        project_type = "<?php echo $online_payment_detail[0]->project_type; ?>";
        $.ajax({
            ...
            success: function(data) {
                ...
                setTimeout(() => {
                    $("#project_id").val("<?php echo $online_payment_detail[0]->project_id; ?>").trigger('change.select2');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                setTimeout(() => {
                    $("#project_site_id").val("<?php echo $online_payment_detail[0]->project_site_id; ?>").trigger('change.select2');
                }, 1000);
            }
        });
        //----------------------------------------vendor
        $.ajax({
            ...
            success: function(data, textStatus, jQxhr) {
                ...
                $("#vendor_id").val("<?php echo $online_payment_detail[0]->vendor_id; ?>").trigger('change.select2');
            },
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jQxhr) {
                ...
                $('#bank_id').append(data);
                $("#bank_id").val("<?php echo $online_payment_detail[0]->bank_id; ?>").trigger('change.select2');
            },
            error: function(jqXhr, textStatus, errorThrown) {
                console.log(errorThrown);
            }
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jQxhr) {
                ...
                $("#bank_details").val("<?php echo $online_payment_detail[0]->bank_details; ?>").trigger('change.select2');
            },
            error: function(jqXhr, textStatus, errorThrown) {
                console.log(errorThrown);
            }
        ...
        if (transaction_type == 'Debit Card' || transaction_type == 'Credit Card') {
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jQxhr) {
                    ...
                    $('#transaction_id').val("<?php echo $online_payment_detail[0]->transaction_id; ?>").trigger('change.select2');
                },
                error: function(jqXhr, textStatus, errorThrown) {
                    console.log(errorThrown);
                }
        ...
        $('#client_id,#project_type').change(() => { //projects
            //project list
