    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            <div class="white-box">
                ...
                if (in_array(3, $role)) {
                    ?>
                    <a href="{{ route('admin.get_online_tds_report') }}" class="btn btn-primary"><i class="fa fa-file" aria-hidden="true"></i> TDS Report</a>
            ...
            $(document).ready(function () {
                ...
                var table = $('#policy_table').DataTable({
                    ...
                    "columns": [
                        ...
                        {"taregts": 3, "searchable": true, "data": "user_name"},
                        ...
                        {"taregts": 7, "searchable": true, "data": "other_project_detail"},
                        ...
                        {"taregts": 11, "searchable": true, "data": "transation_detail"},
                        {"taregts": 12, "searchable": true, "data": "transaction_type"},
                        {"taregts": 13,
                            "render": function (data, type, row) {
                        ...
                        {"taregts": 21, "searchable": true, "data": "section_type"},
                        ...
                        {"taregts": 23, "searchable": true, "data": "entry_completed"},
                        {"taregts": 24, "searchable": true, "data": "invoice_no"},
                        ...
                        },
                        {
                            ...
                            "render": function(data, type, row) {
                                ...
                                if(row.first_approval_date_time){
                                    app_date = moment(row.first_approval_date_time).format("DD-MM-YYYY hh:ss A");
                                }
                        ...
                        },
                        {
                            ...
                            "render": function(data, type, row) {
                                ...
                                if(row.second_approval_date_time){
                                    app_date = moment(row.second_approval_date_time).format("DD-MM-YYYY hh:ss A");
                                }
                        ...
                        },
                        {
                            ...
                            "render": function(data, type, row) {
                                ...
                                if(row.third_approval_date_time){
                                    app_date = moment(row.third_approval_date_time).format("DD-MM-YYYY hh:ss A");
                                }
                        ...
                        {"taregts": 31, "searchable": false, "orderable": false,
                            "render": function (data, type, row) {
                                var id = row.id;
                                var out = "";
                                if (row.second_approval_status == 'Pending') {
