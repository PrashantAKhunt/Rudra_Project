                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        <form action="{{ route('admin.save_tds_section') }}" id="tds_form" method="post">
                            ...
                            <input type="text" class="form-control" name="section_type" id="section_type" value="{{$section_detail['section_type']}}" />
                                 <input type="hidden" name="id" id="id" value="{{$section_detail['id']}}">
