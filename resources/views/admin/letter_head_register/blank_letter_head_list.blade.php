        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            <div class="white-box">
                @if(config::get('constants.Admin') == Auth::user()->role)
                    <a href="{{ route('admin.add_letter_head_register') }}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add Leter Head</a>
                @endif
        ...
        <script>
            $(document).ready(function () {
                ...
                var table = $('#company_table_last').DataTable({
                    ...
                    stateSave: true,
                    "ajax": {
                        url: "<?php echo route('admin.get_blank_letter_head_list'); ?>",
                        type: "GET",
                    },
                    "columns": [
