                    ...
                    <table id="approval_table" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Letter Head start No</th>
                                <th>Letter Head End No</th>
                                <th>Requested By</th>
                                <th>Status</th>
                                <th>Action</th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$data->letter_head_ref_no}}</td>
                                <td>{{$data->letter_head_start_number}}</td>
                                <td>{{$data->letter_head_end_number}}</td>
                                <td>{{$data->name}}</td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a href="#" title="Accept" onclick="accept_confirm(this);" data-href="{{ route('admin.accept_approval_letter_head_ref',['id'=>$data->id]) }}" class="btn btn-success btn-rounded"> <i class="fa fa-check"></i></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content" id="model_data">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{ route('admin.reject_approval_letter_head_ref') }}" id="add_delivery">
                            @csrf
                            <div class="row">
                                <div class="col-xs-12">

                                    <label for="reject_note">Reject note</label>
                                    <input type="hidden" name="letter_head_id" id="letter_head_id" value="">
