           ...
           <div class="white-box">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        @endif
                        <form action="{{ route('admin.insert_department') }}" id="insert_department_frm" method="post">
                            @csrf
                            <div class="form-group "> 
                                <label>Department Name <strong> <span class="text-danger">*</span></strong> </label> 
                                <input type="text" class="form-control" name="dept_name" id="dept_name" value="" /> 
                            </div>

                            <div class="form-group "> 
                                <label>Department Description <span class="text-danger">*</span></strong> </label> 
...
<script>
    $(document).ready(function(){
        ...
        $('#insert_department_frm').validate({
            rules:{
                dept_name:{
                    required:true
                },
