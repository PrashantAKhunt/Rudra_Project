        ...
        function delete_file(del_id,id, i_id) {
            ...
            $(document).ready(function () {
                ...
                var table = $('#policy_table').DataTable({
                    ...
                    "columns": [
                        {"targets": 0, "searchable": true, "data": "entry_code"},
                        {"targets": 1, "searchable": true, "data": "user_name"},
                        {"targets": 2, "searchable": true, "data": "company_name"},
                        ...
                        {"targets": 4, "searchable": true, "data": "project_name"},
                        {"targets": 5, "searchable": true, "data": "other_project_detail"},
                        {"targets": 6, "searchable": true, "data": "site_name"},
                        {"targets": 7, "searchable": true, "data": "vendor_name"},
                        {"targets": 8, "searchable": true, "data": "note"},
                        {"targets": 9,
                        ...
                        {"targets": 10, "searchable": true, "data": "bank_name"},
                        {"targets": 11, "searchable": true, "data": "ch_no"},
                        {"targets": 12, "searchable": true, "data": "total_amount"},
                        {"targets": 13, "searchable": true, "data": "amount"},
                        ...
                        {"targets": 19, "searchable": false, "orderable": false,
                            "render": function (data, type, row) {
                                var id = row.id;
                                var out = "";
