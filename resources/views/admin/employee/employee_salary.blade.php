            ...
            <div class="white-box">
                ...
                <div class="row">
                    ...
                    <table id="emp_table" class="table table-striped">
                        ...
                        <th>Employer PF</th>
                        <th>Gross Salary</th>
                        <th>Gross Salary P.M. (CTC)</th>
                        <th>Through pay slip</th>
                        <th>Salary Month</th>
                        <th>Salary Year</th>
                        <th>Action</th>
                        </thead>
...
<script>
    ...
    var table = $('#emp_table').DataTable({
        ...
        "columns": [
            ...
            {"taregts": 4, 'data': 'professional_tax'
            },
            {"taregts": 5, 'data': 'PF_amount'
            },
            {"taregts": 6, 'data': 'employer_pf_amount'
            },
            {"taregts": 7, 'data': 'total_month_salary'
            },
            {"taregts": 8, 'data': 'gross_salary_pm_ctc'
            },
            {"taregts": 9, 'data': 'payslip_amount',"searchable": false,"orderable": false,
            },
            {"taregts": 10, 'data': 'salary_month'
            },
            {"taregts": 11, 'data': 'salary_year'
            },
