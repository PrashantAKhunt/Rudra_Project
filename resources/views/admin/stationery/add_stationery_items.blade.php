            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                            <form action="{{ route('admin.insert_stationery_items') }}" id="add_stationery" method="post" enctype="multipart/form-data">
                            @csrf
                       
                            <div class="row">
<div class="col-md-6"> 
                             <div class="form-group "> 
                                <label>Stationery Item Name <span class="error">*</span> </label> 
...
<div class="col-md-6"> 
                            <div class="form-group "> 
                                <label>Stationery Item Detail <span class="error">*</span> </label> 
                                <textarea class="form-control" rows="3" name="item_detail" id="item_detail">
                                </textarea>
                            </div>
                            </div>
                    </div>   
...
<div class="col-md-6"> 
                             <div class="form-group "> 
                                <label>Stationery Item Price <span class="error">*</span> </label> 
...
<div class="col-md-6"> 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group "> 
                                    <label>First Approval User <span class="error">*</span> </label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group "> 
                                    <label>Second Approval User <span class="error">*</span> </label>
