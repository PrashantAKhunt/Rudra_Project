                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $singleValue->total_fuel_quality; ?></td>
                                        <td><?= $singleValue->meter_reading; ?></td>
                                        ...
                                        <td>
                                            ...
                                            <b class="text-success">
                                                ...
                                                @if($singleValue->first_approval_datetime)
                                                    {{date('d-m-Y h:i A', strtotime($singleValue->first_approval_datetime))}}
                                                @endif
                                        ...
                                        <td>
                                            ...
                                            <b class="text-success">
                                                ...
                                                @if($singleValue->first_approval_datetime)
                                                    {{date('d-m-Y h:i A', strtotime($singleValue->second_approval_datetime))}}
                                                @endif
                                        ...
                                        <td>
                                            ...
                                            <b class="text-success">
                                                ...
                                                @if($singleValue->first_approval_datetime)
                                                    {{date('d-m-Y h:i A', strtotime($singleValue->third_approval_datetime))}}
                                                @endif
                ...
                var table = $('#expense_table').DataTable({
                    ...
                    "columns": [{
                        ...
                        },
                        {
                            "taregts": 7,
                            "render": function(data, type, row) {
                                return row.fuel_price;
                            }
                        },
                        {"targets": 8, "render": function (data, type, row) {
                                if(row.total_fuel_quality != "null"){
                                    return row.total_fuel_quality;
                                }else{
                                    return "N/A";
                                }
                            }
