           ...
           <div class="white-box">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        @endif
                        <form action="{{ route('admin.insert_compliance_category') }}" id="insert_sender_frm" method="post">
                            @csrf
                            ...
                            <div class="form-group "> 
                                ...
                                <textarea class="form-control" rows="5" name="compliance_detail" id="compliance_detail"></textarea>
                            </div>
