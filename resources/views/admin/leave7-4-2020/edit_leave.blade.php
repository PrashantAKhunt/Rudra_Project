                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        <form action="{{ route('admin.update_leave') }}" id="edit_leave" method="post">
                            ...
                            <div class="form-group ">
                                <label>Select Leave dates and leave types on start and end date</label>
...
<!--                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                <label>Select Work Reliever</label>
                                ...
                                <select name="assign_work_user_id" class="form-control select2 m-b-10" data-placeholder="Select Work Reliever">
                                    ...
                                    <option @if($leave_detail[0]->assign_work_user_id==$team_user->id) selected @endif value="{{$team_user->id}}">{{$team_user->name}}</option>
                                    @endforeach								
                                </select>
                            ...
                            <div class="form-group ">
                                <label>Reliever Work Detail</label>
                                <textarea name="assign_work_details" id="assign_work_details" class="form-control" >{{ $leave_detail[0]->assign_work_details }}</textarea>
                            </div>
