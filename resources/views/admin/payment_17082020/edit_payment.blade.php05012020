                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        <form action="{{ route('admin.update_payment') }}" id="update_payment" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group "> 
                                <input type="hidden" name="cheque_number" id="cheque_number" value="{{ $cheque_number[0]->id }}" />
                                <label>Cheque Number: </label> 
                                {{ $cheque_number[0]->ch_no }}
                            </div>      

                            <div class="form-group "> 
                                <label>Cheque Issue Date</label> 
                                <input type="text" class="form-control" name="issue_date" id="issue_date" value="<?php echo date('d-m-Y', strtotime($cheque_number[0]->issue_date)); ?>" /> 
                            </div>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jQxhr) {
                ...
                $("#cheque_number").val("<?php echo $bank_payment_detail[0]->cheque_number; ?>");
            },
            error: function (jqXhr, textStatus, errorThrown) {
                console.log(errorThrown);
            }
