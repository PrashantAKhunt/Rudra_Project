                        ...
                        <form action="{{ route('admin.save_tender_pattern') }}" id="tender_pattern_form" method="post">
                            ...
                            <div class="form-group ">
                                <label>Tender Pattern Name <span class="error">*</span> </label>
                                 <input type="text" class="form-control" name="tender_pattern_name" id="tender_pattern_name" value="" />
                                 <input type="hidden" name="id" id="id" value="">
                                  
                            </div>
                            <div class="form-group ">
                                <label>Tender Pattern Detail</label>
                                 <input type="text" class="form-control" name="tender_pattern_detail" id="tender_pattern_detail" value="" /> 
                            </div>
