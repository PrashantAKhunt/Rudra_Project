            ...
            $(document).ready(function () {
                ...
                $('#all_employee_expense_list_table').DataTable({
                    ...
                    "columns": [
                        ...
                        {"taregts": 15, "searchable": true, "render":function(data,type,row){
                                if (row.bank_name) {
                        ...
                        {"taregts": 26, "searchable": true, "render":function(data,type,row){
