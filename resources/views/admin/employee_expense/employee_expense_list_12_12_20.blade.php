            ...
            $(document).ready(function () {
                ...
                $('#all_employee_expense_list_table').DataTable({
                    ...
                    "columns": [
                        ...
                        {"taregts": 19, "searchable": false, "orderable": false,"render":function(data,type,row){
                                var out = '';
                        ...
                        {"taregts": 20, "searchable": true, "render":function(data,type,row){
                        ...
                        {"taregts": 27, "searchable": true, "render":function(data,type,row){
