                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        <form action="{{ route('admin.update_job_opening') }}" id="job_opening_frm" method="post">
                            ...
                            <div class="form-group ">
                                <label>Job Role <span class="error">*</span> </label>
                            ...
                            <div class="form-group ">
                                <label>Job Post Date <span class="error">*</span> </label>
                                <input type="text" class="form-control" name="posting_date" id="posting_date" value="{{ $job_opening[0]->posting_date }}" />
                            </div>
                            <div class="form-group ">
                                <label>Recruitment Consultancy <span class="error">*</span> </label>
                            ...
                            <!--  2 new fields added start from here -->

                            <div class="form-group">

                                <label>Urgency of requirement</label>
                                <textarea class="form-control" name="urgency_requirement" id="urgency_requirement" cols="15" rows="5"><?php echo ($job_opening[0]->urgency_requirement) ?></textarea>


                            </div>
                            <div class="form-group">
                                <label>Qualification</label>
                                <input type="text" class="form-control" name="qualification" multiple="multiple" id="qualification" data-role="tagsinput" value="{{$job_opening[0]->qualification}}">

                            </div>

                            <!--  2 new fields added Ends here -->
