                    ...
                    <div class="col-sm-6 col-xs-6">
                        ...
                        <form action="{{ route('admin.insert_job_opening') }}" id="job_opening_frm" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="urgency_requirement" id="urgency_requirement"  cols="15" rows="5"></textarea>

                            </div>
                            <!--  2 new fields added Ends here -->
                            <div class="form-group">
                                <label>Qualification</label>
                                <input type="text" class="form-control" name="qualification" multiple="multiple" id="qualification" data-role="tagsinput">
...
@section('script')
<script>
$('.qualification').tagsinput('refresh');
