               ...
               // access_rule = access_rule.split(',');
                ...
                var table = $('#policy_table').DataTable({
                    ...
                    "columns": [
                        ...
                        {"taregts": 3, "searchable": true, "data": "dept_name"},
                        {"taregts": 4, "searchable": true, "data": "vendor_name"},
                        {"taregts": 5, "searchable": true, "data": "description"},
                        {"taregts": 6, "searchable": true, "data": "remark_by_user"},
                        {"taregts": 7, "searchable": true, "data": "request_amount"},
                        {"taregts": 8, "searchable": true, "data": "schedule_date_from"},
                        {"taregts": 9, "searchable": true, "data": "schedule_date_to"},
                        {"taregts": 10, "searchable": true, "data": "mode_of_payment"},

                        {"taregts": 11, "searchable": true, "data": "project_name"},
                        {"taregts": 12, "searchable": true, "data": "total_amount"},
                        {"taregts": 13, "searchable": true, "data": "approved_amount"},
                        {"taregts": 14, "searchable": true, "data": "approval_remark"},
                        {"taregts": 15, "searchable": true, "data": "hold_amount"},
                        {"taregts": 16, "searchable": true, "data": "remain_hold_amount"},
                        {"taregts": 17, "searchable": true, "data": "final_approved_amount"},
                        {
                            "taregts": 18,
                            "searchable": false,
