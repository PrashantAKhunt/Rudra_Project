               ...
               // access_rule = access_rule.split(',');
                ...
                var table = $('#policy_table').DataTable({
                    ...
                    "columns": [
                        ...
                        {"taregts": 17, "searchable": true, "data": "approval_remark"},
                        {"taregts": 18, "searchable": true, "data": "hold_amount"},
                        {"taregts": 19, "searchable": true, "data": "remain_hold_amount"},
                        {"taregts": 20, "searchable": true, "data": "final_approved_amount"},
                        {
                            "taregts": 21,
                            "searchable": false,
                            "render": function(data, type, row) {
