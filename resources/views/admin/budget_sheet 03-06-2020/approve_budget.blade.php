                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" readonly="" id="hold_amount" name="hold_amount" value="{{ (float)$budget_data[0]->hold_amount }}"/>
                                    </div>
                                </div>
...
<script>
    ...
    function set_current_hold_amt(){
        ...
        $('#hold_amount').val(total_req_amt-approved_amt);
    }
