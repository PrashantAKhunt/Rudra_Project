                                    ...
                                    <div class="panel-body">
                                      <form method="post" id="final_sub_form" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                          <div class="col-md-3">
                                            <div class="form-group">
                                              <label class="control-label">Submission Status</label>
                                          ...
                                          <div class="col-md-3 final_sub_div" style="display: none;">
                                            <div class="form-group">
                                              <label class="control-label">Submission Number</label>
                                          ...
                                          <div class="col-md-3 final_sub_div" style="display: none;">
                                            <div class="form-group">
                                              <label class="control-label">Submission DateTime</label>
                                          ...
                                          <div class="col-md-2 final_sub_div" style="display: none;">
                                            <div class="form-group">
                                              <label class="control-label">Submission File</label>
