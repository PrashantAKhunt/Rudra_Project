...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            @endif
            <div class="white-box">
                <h3 class="box-title m-t-0">Add Tender Permission</h3>
                <div class="row">
                ...
                <h3 class="box-title m-t-0">Edit Tender Permission</h3>
                <div class="row">
                ...
                <h3 class="box-title m-t-0">Default Tender Assign User</h3>
                <div class="row">
                ...
                <h3 class="box-title m-t-0">Tender Assign User</h3>
                <div class="row">
