            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        @endif
                        <form action="{{ route('admin.insert_vendors_bank') }}" id="add_vendor_bank" method="post">
                            @csrf
                            ...
                            <div class="form-group ">
                                <label>Vendors <span class="error">*</span> </label>
                            ...
                            <div class="form-group ">
                                <label>MICR Code<span class="error">*</span> </label>
                                <input class="form-control" name="micr_code" id="micr_code" />
                            </div>

                            <div class="form-group ">
                                <label>SWIFT Code<span class="error">*</span> </label>
                                <input class="form-control" name="swift_code" id="swift_code" />
                            </div>
                            <div class="form-group ">
        ...
        if (company_id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#vendors_list").empty();
                    $("#vendors_list").append("<option value='' disabled selected>Please select</option>");
                    $.each(data, function(index, vendors_obj) {
                        //alert(key);
                        if(vendors_obj.vendor_name != "Others" && vendors_obj.vendor_name != "Other")
...
<script>
    jQuery("#add_vendor_bank").validate({
        ignore: [],
        rules: {
            bank_name: {
                required: true,
