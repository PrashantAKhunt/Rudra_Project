            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        @endif
                        <form action="{{ route('admin.insert_holiday') }}" id="add_holiday" method="post">
                            @csrf
                            ...
                            <div class="form-group ">
                                <label>Date <span class="text-danger">*</span></strong> </label>
                            ...
                            <div class="form-group">
                                <label>Year</label>
                                <select class="form-control select2" class="year" name="year" id="year">@foreach($year_list as $key => $value)
                                    <option value="{{ $value }}" <?php if(now()->year == $value){ ?> selected <?php } ?> > {{ $value }}</option>
                                @endforeach
                                </select>
                            </div>
							...
							<div class="form-group ">                                
                                <div class="checkbox checkbox-success">
                                    <input id="is_optional" name="is_optional" type="checkbox" class="form-control">
