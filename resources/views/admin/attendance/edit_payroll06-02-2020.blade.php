                ...
                <div class="white-box">           
                    ...
                    <div class="row">                        
                        ...
                        <div class="col-sm-6 col-xs-6">
                            <div class="form-group ">
                                <label>HRA</label>
                                <input type="number" class="form-control" name="hra" id="hra" value="{{ $payroll_detail[0]->hra }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">                        
                        <div class="col-sm-6 col-xs-6">                        
                            <div class="form-group ">
                                <label>Others</label>
                                <input type="number" class="form-control" name="others" id="others" value="{{ $payroll_detail[0]->others }}" />
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <div class="form-group ">
