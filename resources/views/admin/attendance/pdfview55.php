    ...
    <tr>
        <td style="text-align: center;">
            ...
            <table cellpadding="0" cellspacing="0" style="text-align: left; border: 0; width: 100%;">
                <tr>
                    <td style="padding: 0px 40px 0px 40px;">
                        <p>MONTH DAYS : <?php echo $data->total_month_days; ?></p>  
                    </td>
                    <td style="padding: 0px 40px 0px 40px;">
                        <p>WORKING DAYS : <?php echo $data->working_day; ?></p>
                    </td>
                    <td style="padding: 0px 40px 0px 40px;" >
                        <p>PRESENT DAYS : <?php echo $data->total_paid_days; ?></p>
                    </td>
                    <td style="padding: 0px 40px 0px 40px;" >
                        <p>TOTAL LEAVE : <?php echo $data->total_leave; ?></p>
                    </td>
                    <td style="padding: 0px 40px 0px 40px;">
                        <p>DAYS PAYABLE : <?php echo $data->employee_working_day; ?></p>
                    </td>
<!--                     <td style="padding: 0px 40px 0px 40px;">
                        <p>lop days : 0.0</p>
                    </td> -->
            ...
            <table cellpadding="0" cellspacing="0" style="text-align: left; border: 0; width: 100%;">
                ...
                <tr>
                    ...
                    <td style="padding: 0px 40px 0px 40px;">Manual Penalty
                    </td>
                    <td style="padding: 0px 40px 0px 40px;"><?php echo $data->manual_penalty; ?></td>
                </tr>
                <tr>
                    <td style="padding: 16px 40px 16px 40px; border-right: 2px solid;"></td>
                    <td style="padding: 0px 40px 0px 40px; border-right: 2px solid;"></td>
                ...
                <?php
                    ...
                    ?>
                <tr>
                    <th style="padding: 16px 40px 16px 40px; border-top: 2px solid; text-transform: capitalize">Rs. <?php echo ucfirst($result) . "Rupees  " . ucfirst($points) . " Paise"; ?></th>
