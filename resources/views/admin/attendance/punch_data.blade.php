                                ...
                                <?php if(!empty($value['OUT'])){ 
                                    if($value['OUT'] == 'UNSET'){ ?>
                                        <td width="50%" class="block">
                                            ...
                                            <div class="col-sm-3">
                                                @if($punch_data[$key]['is_last_entry'])
                                                <button onClick="setTime(this);" class="btn btn-block btn-success btn-rounded" data-min="{{ $punch_data[$key]['IN'] }}" data-max="{{ date('h:i A',strtotime('23:58:00')) }}" data-type="OUT" data-id="{{ $id }}" >Save</button>
                                                @else
                                            ...
                                            @if($punch_data[$key]['is_last_entry'])
                                            <div class="col-sm-12 hide condition"><span class="help-block">Select time between {{ $punch_data[$key]['IN'] }} To {{ date('h:i A',strtotime('23:58:00')) }}</span></div>
                                            @else
