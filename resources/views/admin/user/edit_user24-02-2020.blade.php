                            ...
                            <div class="row">
								...
								<div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" readonly="" class="form-control" name="joining_date" id="joining_date" value="{{ date('d-m-Y',strtotime($user_detail[0]->joining_date)) }}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div> 
                                            <input type="file" name="digital_signature" class="form-control" id="digital_signature"  value="{{ $user_detail[0]->digital_signature}}" accept="image/x-png, image/jpg, image/jpeg" data-accept="jpg,png,jpeg"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
