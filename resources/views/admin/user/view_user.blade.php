						...
						<div class="row">
                            ...
                            <div class="col-md-3 col-xs-6 b-r"> <strong>Reporting User</strong> <br>
                             ...
                             <div class="col-md-3 col-xs-6 b-r"> <strong>Digital Signature</strong> <br>
                                ...
                                @else
                                    <a class="image-popup-no-margins" href="{{ asset('storage/'.str_replace('public/','',!empty($user_detail[0]->digital_signature) ? $user_detail[0]->digital_signature : 'public/no_image')) }}" data-effect="mfp-zoom-in"><img src="{{ asset('storage/'.str_replace('public/','',!empty($user_detail[0]->digital_signature) ? $user_detail[0]->digital_signature : 'public/no_image')) }}" class="img-responsive" /></a>
                                @endif
                            </div>
                        </div>
                    </div>
