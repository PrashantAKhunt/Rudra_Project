                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('admin.insert_user') }}" enctype="multipart/form-data" id="add_user" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="file" name="digital_signature" class="form-control" id="digital_signature" value="" accept="image/x-png,image/png, image/jpg, image/jpeg" data-accept="jpg,png,jpeg" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    <div id="yes-info" style="display: none;">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="pf_num" id="pf_num" placeholder="PF Number 9876543210" style="display: block;">
                                        </div>
                                    </div>
                                </div>
                                <!--  -->
                            ...
                            <!-- commented as asked to removre  bcz as per update  to remove this section -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <input type="file" accept="image/x-png,image/png, image/jpg, image/jpeg" name="degree_certificate[]" id="degree_certificate0" class="dropify" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <input type="file" id="input-file-now" accept="image/x-png,image/png, image/jpg, image/jpeg,application/pdf" name="exp_document[]" class="form-control" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input type="file" id="identity_document" accept="image/x-png,image/png, image/jpg, image/jpeg" name="identity_document" required class="dropify" />
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    //  new script for insurance section in add employee 
    ...
    $(document).ready(function() {
        ...
        $('#super_admin_checker_id').select2({
