                    ...
                    <table id="doc_table" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if($view_special_permission)
                                    @if($list_data->is_special=='Yes')
                                    <a href="{{ route('admin.is_doc_special',['id'=>$list_data->id,'type'=>'No']) }}" class="btn btn-success" title="Click To No">Yes</a>
                                    @else
                                    <a href="{{ route('admin.is_doc_special',['id'=>$list_data->id,'type'=>'Yes']) }}" class="btn btn-danger" title="Click To Yes">No</a>
                                    @endif
                                @else
                                    @if($list_data->is_special=='Yes')
                                    <a href="#" class="btn btn-success" title="Click To No">Yes</a>
                                    @else
                                    <a href="#" class="btn btn-danger" title="Click To Yes">No</a>
                                    @endif
                                @endif
