    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            <div class="white-box">
                ...
                @endif
                <!-- <form action="{{ route('admin.inwards') }}" method="POST" id="range_date"> -->
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="table-responsive">
                    <table id="user_table" class="table table-striped">
                        <thead>
                            <tr>
                                <th width="100px">Inward Registry No</th>
                                <th width="100px">Inward Title</th>
        ...
        <script>
            $(document).ready(function () {
                var table = $('#user_table').DataTable({
                    ...
                    "ajax": {
                        url: "<?php echo route('admin.inwards'); ?>",
                        type: "GET",
                        "data": function ( d ) {
                    ...
                    "columns": [{
                        ...
                        },
                        {
                            ...
                            "render": function(data, type, row) {
                                var id = row.id;
                                var out = "";
                                out = '<a href="<?php echo url('view_inward_to_outward') ?>' + '/' + id + '/inward" class="btn btn-primary btn-rounded" title="view records"><i class="fa fa-eye" aria-hidden="true"></i></a>';
