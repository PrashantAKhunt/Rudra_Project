                    ...
                    <table id="all_employee_expense_list_table" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr @if($expense_category->voucher_repeat === 1) class="error" @endif>
                                ...
                                <td>
                                    @if($expense_category->bank_name)
                                    {{ $expense_category->bank_name." (".$expense_category->ac_number.")" }}
                                    @else
                                    N/A
                                    @endif
                                </td>
                                <td>@if($expense_category->ch_no)
                                    {{ $expense_category->ch_no }}
                                    @else
                                    N/A
                                    @endif</td>
                                <td>@if($expense_category->rtgs_number)
                                    {{ $expense_category->rtgs_number }}
                                    @else
                                    N/A
                                    @endif</td>
                                <td>@if($expense_category->voucher_no)
                                    {{ $expense_category->voucher_no }}
                                    @else
                                    N/A
                                    @endif</td>
                                <td>@if($expense_category->transaction_note)
                                    {{ $expense_category->transaction_note }}
                                    @else
                                    N/A
                                    @endif</td>
...
@if($expense_category->status=="Pending")
<b class="text-warning">{{ $expense_category->status }}</b>
@elseif($expense_category->status=="Approved")
<b class="text-success">{{ $expense_category->status }}</b>
@elseif($expense_category->status=="Rejected")
<b class="text-danger">{{ $expense_category->status }}</b>
@endif
                ...
                if (bank_id) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            //$("#cheque_number").select2("val", "");

                            //$("#cheque_number").append("<option value='' selected>Please select</option>");
                            $.each(data, function(index, cheque_obj) {
                                $("#cheque_number").append('<option value="' + cheque_obj.id + '">' + cheque_obj.ch_no + '</option>');
                            });

                            let cheque_val = $('#ch_no').val();
                            $('#cheque_number').val(cheque_val);
                            $('#cheque_number').trigger('change');
            ...
            function approve_confirmByAccountant(id) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        /*  $('#cheque_number').val(data.data.expense_records[0].cheque_number); */
                        ...
                        //$("#bank_id").append("<option value='' selected>Please select</option>");
