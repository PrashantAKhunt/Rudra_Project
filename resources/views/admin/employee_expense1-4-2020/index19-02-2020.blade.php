                                ...
                                <td>
                                    ...
                                    <div id="gallery-content">
                                        <div id="gallery-content-center">
                                            ...
                                            <!--                                            <a href="{{asset('storage/' . str_replace('public/', '', $expense_category->expense_image))}}" data-toggle="lightbox"  data-title="">
                                                                                            
                                                                                            <img width="100px" height="100px" src="{{asset('storage/' . str_replace('public/', '', $expense_category->expense_image))}}" alt="gallery" class="all studio"/> 
                                                                                            
                                                                                        </a>-->
                                        </div>
                                    </div>
                                    <!--                                    <a target="_blank" href="{{asset('storage/' . str_replace('public/', '', $expense_category->expense_image))}}" title="View Expense Image">
                                                                            <img width="100px" height="100px" src="{{asset('storage/' . str_replace('public/', '', $expense_category->expense_image))}}" alt="gallery" class="all studio"/> 
                                                                        </a>-->
                                    @endif
                                </td>
