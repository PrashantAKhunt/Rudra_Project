        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <table id="inwards_doc_table" class="table table-striped">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                        @foreach($inwards_docs as $list_data)
                            <tr>
                            ...
                            <td><span style="display: none;">{{ $list_data->received_date }}</span>
                                ...
                                <td><a title="View Details" href="{{ route('admin.view_inward_to_outward',['id'=>$list_data->parent_inward_outward_no]) }}" class="btn btn-rounded btn-primary"><i class="fa fa-eye"></i></a></td>  
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
