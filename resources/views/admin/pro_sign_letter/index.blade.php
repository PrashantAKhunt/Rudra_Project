    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            <div class="white-box">                
                ...
                if (in_array(3, $role)) {
                    ?>
                    <a href="{{ route('admin.add_pro_sign_letter_detail') }}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add Blank Letter-head Request</a>
                <?php } ?>
            ...
            $(document).ready(function () {
                ...
                var table = $('#policy_table').DataTable({
                    ...
                    "columns": [
                        ...
                        {"taregts": 9, "searchable": false,"orderable": false, "render": function (data, type, row) {
