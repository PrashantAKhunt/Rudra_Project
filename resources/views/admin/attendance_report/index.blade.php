...
<div class="container-fluid">
    ...
    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control valid" id="report_type" name="report_type">
                                                    ...
                                                    <option <?php if ($report_type == "late_mark") { ?> selected <?php } ?> value="late_mark">Emp. Late Mark Remove</option>
                                                    <option <?php if ($report_type == "manually_attendance") { ?> selected <?php } ?> value="manually_attendance">Emp. Manually Attendace</option>
        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            @endif
            <div class="white-box">
                <a href="{{ $csv_data }}"  class="btn btn-primary pull-right btn-sm ml-2"><i class="fa fa-download "></i> Download CSV</a>
                @if(isset($excel_data) && !empty($excel_data))<a href="{{ $excel_data }}"  class="btn btn-primary btn-sm pull-right mr-2 ml-2"><i class="fa fa-download "></i> Download Excel</a>@endif
...
<?php } ?>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            @foreach($records as $key=>$leave_data)
                            <tr>
                            <td>{{ $leave_data->employee_name }}</td>
                                <td>{{ $leave_data->emp_code }}</td>
                                <td>{{ Carbon\Carbon::parse($leave_data->date)->format('d-m-Y') }}</td>
                                <td>{{ Carbon\Carbon::parse($leave_data->first_in)->format('h:i A') }}</td>
                                <td>{{ Carbon\Carbon::parse($leave_data->last_out)->format('h:i A') }}</td>
                                <td>{{ $leave_data->total_hours }}</td>

                                <td>{{ $leave_data->is_late }}</td>
                                <td>{{ $leave_data->is_late_more }}</td>
                                <td>{{ $leave_data->late_time }}</td>

                                <td>{{ $leave_data->late_mark_removed_detail }}</td>
                                <td>{{ $leave_data->removed_by_username }}</td>
                            </tr>
                            @endforeach
                            @else
                            <tr>
                    ...
                    @elseif($leavebalance == 'manually_attendance')
                    <table class="table table-striped">
                        <thead>
                        <th>Employee Name</th>
                        <th>Employee ID</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $leave_data->manual_add_reason }}</td>
                                <td>{{ $leave_data->add_by_username }}</td>
                            </tr>
                            @endforeach
                            @else
                            <tr>
