...
<div class="container-fluid">
  <div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.outwards') }}">{{ $module_title  }}</a></li>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="white-box">
        <button type="button" onclick="window.location.href ='{{ route('admin.outwards') }}'" class="btn btn-info pull-right"><i class="fa fa-arrow-left"></i> BACK</button>
        @if (session('error'))
            ...
            <ol style="padding-inline-start: 0px">
              ...
              <li @if($key==$received_dates[0] ) class="selected" @endif data-date={{  Carbon\Carbon::parse($key)->format('d/m/Y') }}>
                ...
                <div class="tab-content" style="margin-top:10px;">
                  ...
                  <button class="btn btn-info" title="Outwards No:<?=   $l + 1; ?>"><?=   $l + 1; ?></button>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-xs-12"> <strong>Assign Users</strong> <br>
