                    ...
                    "columns": [     
                        ...
                        {"taregts": 9,
                            "render": function (data, type, row) {
                                var id = row.id;
                                var out = '';
                                if(row.user_attend_type=='Biometric'){
                                out += '<a href="<?php echo url('change_attend_type') ?>'+'/'+id+'/Remote'+'" class="btn btn-success" title="Change Status">'+row.user_attend_type+'</a>';
                                }
                                else{
                                out += '<a href="<?php echo url('change_attend_type') ?>'+'/'+id+'/Biometric'+'" class="btn btn-danger" title="Change Status">'+row.user_attend_type+'</a>';
                                }
                                return out;
                            }
                        },                        
                        ...
                        {"taregts": 11, 'data': 'is_on_probation'},
