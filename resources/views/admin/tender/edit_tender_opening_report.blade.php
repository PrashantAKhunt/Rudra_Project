                                  ...
                                  <div class="panel-wrapper collapse" aria-expanded="true">
                                    <div class="panel-body">
                                      ...
                                      <div class="row">
                                        <div class="col-md-4">
                                          <div class="form-group">
                                            <label class="control-label">Tender Fee Status<span class="error">*</span></label>
                                        ...
                                        <div class="col-md-3 tender_fee_reject_div">
                                          <div class="form-group">
                                            <label class="control-label">Tender Fee Reject Reason<span class="error">*</span></label>
                                        ...
                                        <div class="col-md-4 tender_fee_reject_div">
                                          <div class="form-group">
                                            <label class="control-label">Tender Fee Reject Attachment<span class="error">*</span></label>
                                      ...
                                      <div class="row">
                                        <div class="col-md-4">
                                          <div class="form-group">
                                            <label class="control-label">Tender EMD Status<span class="error">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                          <div class="form-group">
                                            <label class="control-label">Tender EMD Release Date<span class="error">*</span></label>
                                      ...
                                      <div class="row tender_emd_reject_div">
                                        <div class="col-md-4">
                                          <div class="form-group">
                                            <label class="control-label">Tender EMD Reject Reason<span class="error">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                          <div class="form-group">
                                            <label class="control-label">Tender EMD Reject Attachment<span class="error">*</span></label>
                                          ...
                                          @foreach($tender_participated_bidder as $key_p => $value_p)
                                            <div class="participated_bidder" id="participated_bidder_{{$key_p}}">
                                              <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                  <div class="form-group">
                                                    <label class="control-label">Contact Number<span class="error">*</span></label>
                                  ...
                                  <div class="panel-wrapper collapse" aria-expanded="true">
                                    <div class="panel-body">
                                      ...
                                      <div class="row">
                                        <div class="col-md-3">
                                          <div class="form-group">
                                            <label class="control-label">Query Status<span class="error">*</span></label>
                                          ...
                                          {{-- @foreach($tender_opening_status_technical as $key => $value) --}}
                                            {{-- <div class="open_status_tech_part" id="open_status_tech_part_{{$key}}"><hr>
                                              <div class="row open_status_tech_div">
                                                <div class="col-md-3">
                                                  <div class="form-group">
                                                    <label class="control-label">Query Detail<span class="error">*</span></label>
                                                ...
                                                <div class="col-md-3">
                                                  <div class="form-group">
                                                    <label class="control-label">Query Document<span class="error">*</span></label>
                                                ...
                                                <div class="col-md-3">
                                                  <div class="form-group">
                                                    <label class="control-label">Query Receive Date<span class="error">*</span></label>
                                              ...
                                              <div class="row open_status_tech_div">
                                                ...
                                                <div class="col-md-3">
                                                  <div class="form-group">
                                                    <label class="control-label">Query Reply Document<span class="error">*</span></label>
                                                ...
                                                <div class="col-md-3">
                                                  <div class="form-group">
                                                    <label class="control-label">Query Submission Date/Time<span class="error">*</span></label>
                                      ...
                                      <div class="row">
                                        <div class="col-md-4">
                                          <div class="form-group">
                                            <label class="control-label">Technical Part Opening Status<span class="error">*</span></label>
                                        ...
                                        <div class="col-md-3 open_status_tech_reject_div">
                                          <div class="form-group">
                                            <label class="control-label">Technical Part Reject Reason<span class="error">*</span></label>
                                        ...
                                        <div class="col-md-4 open_status_tech_reject_div">
                                          <div class="form-group">
                                            <label class="control-label">Technical Part Reject Attachment<span class="error">*</span></label>
                                  ...
                                  <div class="panel-wrapper collapse" aria-expanded="true">
                                    <div class="panel-body">
                                      ...
                                      <div class="row">
                                        <div class="col-md-4">
                                          <div class="form-group">
                                            <label class="control-label">Financial Part Opening Status<span class="error">*</span></label>
                                        ...
                                        <div class="col-md-3 open_status_fina_reject_div">
                                            <div class="form-group">
                                              <label class="control-label">Financial Part Reject Reason<span class="error">*</span></label>
                                          ...
                                          <div class="col-md-4 open_status_fina_reject_div">
                                            <div class="form-group">
                                              <label class="control-label">Financial Part Reject Attachment<span class="error">*</span></label>
                                    ...
                                    <div class="panel-body">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-4 opening_commercial_reject_div">
                                          <div class="form-group">
                                            <label class="control-label">Reject Reason<span class="error">*</span></label>
                                        ...
                                        <div class="col-md-3 opening_commercial_reject_div">
                                          <div class="form-group">
                                            <label class="control-label">Reject Attachment<span class="error">*</span></label>
                                      ...
                                      <input type="hidden" name="id" value="{{$tender_id}}">
                                        ...
                                        <div class="row">
                                          <div class="col-md-4">
                                            <div class="form-group">
                                              <label class="control-label">Bidder<span class="error">*</span></label>
                                          ...
                                          <div class="col-md-4">
                                            <div class="form-group">
                                              <label class="control-label">Upload Excel<span class="error">*</span></label>
      ...
      $.ajax({
          ...
          success:function(data){
              ...
              if(data.length){
                let bidder_arr = [];
                // console.log(search_id);
                $( ".bidder_name" ).each(function( index ) {
                  // console.log($(this).val());
                  bidder_arr.push($(this).val());
                });
                // console.log(bidder_arr);
                $('#bidderList_'+search_id).html("");
                output = '<ul class="dropdown-menu" style="display:block; position:relative">';
                $.each( data, function(key, value){
                  if(jQuery.inArray(value.bidder_name, bidder_arr) != 1){
...
$.ajax({
  ...
  error : function(statusCode, errorThrown){
    if (statusCode.status == 0) {
        $.toast({
          heading: "Network problem please check your connection",
          // text: 'File not upload try again !!',
          position: 'top-right',
          loaderBg:'#ff6849',
          icon: 'error',
