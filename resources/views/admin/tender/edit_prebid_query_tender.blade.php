                                                  ...
                                                  <div class="pre_bid_meeting" id="pre_bid_meeting_0">
                                                    <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="control-label">Name of Section <span class="error">*</span> </label>
                                                                    <input type="text" class="form-control name_of_section" name="name_of_section[]" id="name_of_section_0">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="control-label">Clause No. <span class="error">*</span> </label>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="control-label">Page No. <span class="error">*</span> </label>
                                    ...
                                    <div class="panel-body">
                                      ...
                                      <input type="hidden" name="id" value="{{$tender_id}}">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Select Query (If corrigendum is for our query) <span class="error">*</span> </label>
  ...
  $("#pre_bid_meeting_add_more").append('<div class="pre_bid_meeting" id="pre_bid_meeting_'+counter_pre_bid+'">'+
                                                    '<div class="row">'+
                                                        ...
                                                        '<div class="row">'+
                                                            ...
                                                            '<div class="col-md-3">'+
                                                                '<div class="form-group">'+
                                                                    '<label class="control-label">Sub Clause No. <span class="error">*</span> </label>'+
