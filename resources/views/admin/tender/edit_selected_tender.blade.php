                                          ...
                                          <div class="row">
                                            <div class="col-md-4">
                                              <div class="form-group">
                                                ...
                                                <input type="text" class="form-control last_date_time_download" name="last_date_time_download" id="last_date_time_download" value="{{ $tender['last_date_time_download'] ? date('d-m-Y H:i a',strtotime($tender['last_date_time_download'])) : ""}}">
                                              </div>
                                            </div>
                                            <div class="col-md-4">
                                              <div class="form-group">
                                                <label for="inputEmail4">Last Date Time Of Online Submit</label>
                                                <input type="text" class="form-control last_date_time_online_submit" name="last_date_time_online_submit" id="last_date_time_online_submit" value="{{ $tender['last_date_time_online_submit'] ? date('d-m-Y H:i a',strtotime($tender['last_date_time_online_submit'])) : ""}}">
                                              </div>
                                            </div>
                                            <div class="col-md-4">
                                              <div class="form-group">
                                                <label for="inputEmail4">Last Date Time Of physical Submit</label>
                                                <input type="text" class="form-control last_date_time_physical_submit" name="last_date_time_physical_submit" id="last_date_time_physical_submit" value="{{ $tender['last_date_time_physical_submit'] ?date('d-m-Y H:i a',strtotime($tender['last_date_time_physical_submit'])) : ""}}">
                                              </div>
                                            </div>
                                          </div>
                                          {{-- <div class="row">
                                ...
                                <div class="panel panel-inverse">
                                  ...
                                  <div class="panel-wrapper collapse" aria-expanded="true">
                                    <div class="panel-body">
                                      ...
                                      @csrf
                                      <input type="hidden" name="id" id="tender_id" value="{{$tender_id}}">
                                        <div class="row">
                                          <div class="col-md-4">
                                            <div class="form-group">
                                              <label class="control-label">Tender Fee <span class="error">*</span> </label>
                                          ...
                                          <div class="col-md-4 tender_fee_div">
                                            <div class="form-group">
                                              <label class="control-label">Tender Fee Amount <span class="error">*</span> </label>
                                          ...
                                          <div class="col-md-4 tender_fee_div">
                                            <div class="form-group">
                                              <label class="control-label">In Favour Of <span class="error">*</span> </label>
                                        ...
                                        <div class="row">
                                          <div class="col-md-4 tender_fee_div">
                                            <div class="form-group">
                                              <label class="control-label">In Form Of <span class="error">*</span> </label>
                                          ...
                                          <div class="col-md-4 tender_fee_div">
                                            <div class="form-group">
                                              <label class="control-label">Tender Fee Validity <span class="error">*</span> </label>
                                        ...
                                        @if(Auth::user()->id == $add_tender_permission || Auth::user()->id == $edit_tender_permission)
                                            @php
                                                $show_tender_fee_btn = "";
                                                $show_tender_fee_request_btn = "";
                                                if(empty($tender['tender_fee'])){
                                                    $show_tender_fee_request_btn = "display:none";
                                                }else{
                                                    if($tender['tender_fee'] == 'No'){
                                                        $show_tender_fee_request_btn = "display:none";
                                                    }
                                                    $show_tender_fee_btn = "display:none";
                                                }
                                            @endphp
                                            <button type="button" class="btn btn-success tender_fee_form_btn" style="{{$show_tender_fee_btn}}">Save Tender Fee</button>
                                            @if ($check_tender_fee == 0)
                                                <button type="button" class="btn btn-success tender_payment_fee_request" style="{{$show_tender_fee_request_btn}}">Tender Payment Request</button>
                                            @endif
                                        @endif
                                      </form>
                                     </div>
                                    ...
                                    <div class="panel-body">
                                      ...
                                      <input type="hidden" name="id" value="{{$tender_id}}">
                                        <div class="row">
                                          <div class="col-md-4">
                                            <div class="form-group">
                                              <label class="control-label">Tender EMD <span class="error">*</span> </label>
                                          ...
                                          <div class="col-md-4 tender_emd_div">
                                            <div class="form-group">
                                              <label class="control-label">Tender EMD Amount <span class="error">*</span> </label>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-4 tender_emd_div">
                                            <div class="form-group">
                                              <label class="control-label">Tender EMD Validity <span class="error">*</span> </label>
                                          ...
                                          <div class="col-md-4 tender_emd_validity_date_div">
                                            <div class="form-group">
                                              <label class="control-label">Tender EMD Validity Date <span class="error">*</span> </label>
                                        ...
                                        @if(Auth::user()->id == $add_tender_permission || Auth::user()->id == $edit_tender_permission)
                                            @php
                                                $show_tender_emd_btn = "";
                                                $show_tender_emd_request_btn = "";
                                                if(empty($tender['tender_emd'])){
                                                    $show_tender_emd_request_btn = "display:none";
                                                }else{
                                                    if($tender['tender_emd'] == 'No'){
                                                        $show_tender_emd_request_btn = "display:none";
                                                    }
                                                    $show_tender_emd_btn = "display:none";
                                                }
                                            @endphp
                                            <button type="button" class="btn btn-success tender_emd_form_btn" style="{{$show_tender_emd_btn}}">Save Tender EMD</button>
                                            @if ($check_tender_emd == 0)
                                                <button type="button" class="btn btn-success tender_payment_emd_request" style="{{$show_tender_emd_request_btn}}">Tender Payment Request</button>
                                            @endif
                                        @endif

                                        {{-- <a href="{{route('admin.add_bank_payment_detail',['tender_id' => $tender_id, 'type' => "emd"])}}"><button type="button" class="btn btn-success">Tender EMD Bank Payment</button></a> --}}
                                      </form>
                                    </div>
                                  </div>
                                </div>
                                            ...
                                            {{-- @foreach($tender_technical_eligibility as $key_te => $value_te) --}}
                                              {{-- <div class="technical_eligibility" id="technical_eligibility_{{$key_te}}">
                                                <div class="row">
                                                  ...
                                                  <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label">Document Attechement <span class="error">*</span> </label>
                                      ...
                                      @csrf
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-3 prebid_meeting_div">
                                              <div class="form-group">
                                                  <label class="control-label">Pre-Bid Meeting Date-time <span class="error">*</span> </label>
                                          ...
                                          <div class="col-md-3 prebid_meeting_div">
                                              <div class="form-group">
                                                  <label class="control-label">Pre-Bid Meeting Venue <span class="error">*</span> </label>
                                          ...
                                          @if(count($tender_bid_meet))
                                            ...
                                            {{-- <div class="pre_bid_meeting" id="pre_bid_meeting_{{$key_bid}}">
                                                <div class="row prebid_meeting_div">
                                                  ...
                                                  <div class="col-md-6">
                                                      <div class="form-group">
                                                          <label class="control-label">Query Point Document  <span class="error">*</span> </label>
                                                  ...
                                                  <div class="col-md-3">
                                                      <div class="form-group">
                                                          <label class="control-label">Document Attachment <span class="error">*</span> </label>
                                    ...
                                    <div class="panel-body">
                                      ...
                                      <input type="hidden" name="id" value="{{$tender_id}}">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="control-label">Corrigendum No. <span class="error">*</span> </label>
                                        ...
                                        <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Sr. As Per Corrigendum <span class="error">*</span> </label>
                                                        <input type="text" class="form-control corrigendum_sr_number required" name="corrigendum_sr_number" id="corrigendum_sr_number">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="inputEmail4">Answer <span class="error">*</span> </label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="inputEmail4">Corrigendum Attachment <span class="error">*</span> </label>
                                            ...
                                            {{-- @foreach($tender_other_communication as $key_com => $value_com) --}}
                                              {{-- <div class="other_communication" id="other_communication_{{$key_com}}">
                                                <div class="row">
                                                  <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label">Other Communication Title <span class="error">*</span> </label>
                                                  ...
                                                  <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label">Other Communication Date <span class="error">*</span> </label>
                                              ...
                                              {{-- @foreach($tender_condition_contract as $key_con => $value_con) --}}
                                                {{-- <div class="tender_condition" id="tender_condition_{{$key_con}}">
                                                  <div class="row">
                                                    <div class="col-md-6">
                                                      <div class="form-group">
                                                          <label class="control-label">Special Condition Title <span class="error">*</span> </label>
                                          ...
                                          @else
                                            <div class="tender_condition" id="tender_condition_0">
                                              <div class="row">
                                                <div class="col-md-6">
                                                  <div class="form-group">
                                                      <label class="control-label">Special Condition TitleSPACIAL CONDITION OF CONTRACT <span class="error">*</span> </label>
                                    ...
                                    <div class="panel-body">
                                      ...
                                      @csrf
                                        ...
                                        <div class="row">
                                          <div class="col-md-4">
                                            <div class="form-group">
                                              <label class="control-label">Select Mode Of Physical Submission <span class="error">*</span> </label>
                                          ...
                                          <div class="col-md-4">
                                            <div class="form-group">
                                              <label class="control-label">Due Date Of Physical Submission <span class="error">*</span> </label>
    ...
    if($("#tender_fee_form").valid()){
      ...
      $.ajax({
        ...
        //   $(".tender_fee_form_btn").attr("disabled", false);
            $(".tender_fee_form_btn").hide();
            if($("#tender_fee").val() == "Yes"){
                $(".tender_payment_fee_request").show();
            }
...
//tender fee payment request
$(".tender_payment_fee_request").on('click',function(){
    // alert($("#tender_id").val());
    // $(".tender_payment_fee_request").attr("disabled", true);
    swal({
        title: "Are you sure?",
        text: "You want send tender payment request!",
        type: "warning",
        ...
        $.ajax({
            type : "POST",
            url : "{{url('tender_payment_request')}}",
            data : {
                "_token" : "{{csrf_token()}}",
            ...
            success:function(data){
                if(data == "success"){
                    $(".tender_payment_fee_request").hide();
                    swal("Deleted!", "Tender payment request send successfully.", "success");
                }else{
                    $(".tender_payment_fee_request").attr("disabled", false);
                    swal("Deleted!", "Tender payment request send successfully.", "success");
                }
...
$(".tender_emd_form_btn").on('click',function(){
    if($("#tender_emd_form").valid()){
      ...
      $.ajax({
        ...
        success : function(data){
        //   console.log(data);
            $(".tender_emd_form_btn").hide();
            if($("#tender_emd").val() == "Yes"){
                $(".tender_payment_emd_request").show();
            }
...
//tender emd payment request
$(".tender_payment_emd_request").on('click',function(){
    // $(".tender_payment_emd_request").attr("disabled", true);
    swal({
        title: "Are you sure?",
        text: "You want send tender payment request!",
        type: "warning",
        ...
        $.ajax({
            ...
            success:function(data){
                if(data == "success"){
                    $(".tender_payment_emd_request").hide();
                    swal("Deleted!", "Tender payment request send successfully.", "success");
                }else{
                    $(".tender_payment_emd_request").attr("disabled", false);
                    swal("Deleted!", "Tender payment request send successfully.", "success");
                }
        ...
        if(data.length){
          ...
          $("#financial_eligibility_add_more").append('<div class="financial_eligibility" id="financial_eligibility_'+key+'">'+
                                                '<div class="row">'+
                                                  ...
                                                  '<div class="col-md-3">'+
                                                    '<div class="form-group">'+
                                                        '<label class="control-label">Document Attachement <span class="error">*</span> </label>'+
