    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> 
                ...
                <div class="top-left-part"><a class="logo" href="{{ route('admin.dashboard') }}"><b><!--This is dark logo icon-->
                    <img src="{{ asset('admin_asset/assets/plugins/images/eliteadmin-logo.png') }}" alt="home" class="dark-logo"><!--This is light logo icon-->
                    <img src="{{ asset('admin_asset/assets/plugins/images/eliteadmin-logo-dark.png') }}" alt="home" class="light-logo">
                </b><span class="hidden-xs"><!--This is dark logo text-->
                    <img src="{{ asset('admin_asset/assets/plugins/images/eliteadmin-text.png') }}" alt="home" class="dark-logo"><!--This is light logo text-->
                    <img src="{{ asset('admin_asset/assets/plugins/images/eliteadmin-text-dark.png') }}" alt="home" class="light-logo"></span></a></div>
        ...
        <div class="white-box">
            <h2 class="box-title">Confirmation Details</h2>
                        ...
                        <div class="panel">
                          ...
                          <div class="panel-collapse collapse" id="exampleCollapseDefaultOne<?php echo $key?>" aria-labelledby="exampleHeadingDefaultOne<?php echo $key?>" role="tabpanel" aria-expanded="false" style="height: 0px;">
                            <div class="panel-body">
                                <?php $path = asset('storage/'.str_replace('public/','',$policy_list_data['name'])); ?>
