            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        @endif
                        <form action="{{ route('admin.insert_attendance_request') }}" id="add_request" method="post">
                            @csrf
...
<div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" onchange="checkHoliday();" name="date" id="date"/>
...
<div class="col-md-9">
                                <div class="form-group ">
                                <label>Reason to Come <span class="error">*</span> </label>
                                <textarea class="form-control" name="reason_note" id="reason_note"></textarea>
                            </div>
                            </div>
...
<div class="col-md-9">
                            <div class="form-group ">
                                <label>Description of Work <span class="error">*</span> </label>
                                <textarea class="form-control" name="description_note" id="description_note"></textarea>
                            </div>
                            </div>
