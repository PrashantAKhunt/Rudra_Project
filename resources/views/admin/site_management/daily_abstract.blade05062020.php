            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="table_heading">Work for day -1</h4>
                                <table class="table table-striped" id="work_for_day1">
                                    <thead>
                                        <tr>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="table_heading">Work for day -2</h4>
                                <table class="table table-striped" id="work_for_day2">
                                    <thead>
                                        <tr>
                                            <td rowspan="2">ITEM NO</td>
                                            <td rowspan="2">ITEM DESCRIPITION</td>
...
@section('script')
<script>
$("#work_for_day1,#work_for_day2").DataTable({
"columnDefs": [
    { "width": "40%", "targets": 1 }
  ]
})
