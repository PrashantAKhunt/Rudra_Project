                        ...
                        <form action="{{ route('admin.save_tender_category') }}" id="tender_category_form" method="post">
                            ...
                            <div class="form-group ">
                                <label>Tender Category <span class="error">*</span> </label>
                                 <input type="text" class="form-control" name="tender_category" id="tender_category" value="{{$category_detail->tender_category}}" />
                                 <input type="hidden" name="id" id="id" value="{{$category_detail->id}}"> 
                            </div>
                            <div class="form-group ">
                                <label>Tender Category Detail</label>
                                 <input type="text" class="form-control" name="tender_category_detail" id="tender_category_detail" value="{{$category_detail->tender_category_detail}}" /> 
                            </div>
