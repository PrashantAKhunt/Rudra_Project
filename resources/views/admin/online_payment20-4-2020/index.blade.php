            ...
            $(document).ready(function () {
                ...
                var table = $('#policy_table').DataTable({
                    ...
                    "columns": [
                        ...
                        {"taregts": 7, "searchable": true, "data": "transation_detail"},
                        {"taregts": 8, "searchable": true, "data": "transaction_type"},
                        ...
                        {"taregts": 11, "searchable": true, "data": "bank_name"},
                        {"taregts": 12, "searchable": true, "data": "amount"},
                        {
                            "taregts": 13,
                            "searchable": false,
                            "render": function(data, type, row) {
