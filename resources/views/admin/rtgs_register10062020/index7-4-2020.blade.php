                    ...
                    "columns": [
                        ...
                        {"taregts": 13,
                            "render": function (data, type, row) {
                                ...
                                if(row.is_used=='not_used'){
                                    if(row.is_signed=='no'){
                                     out += '<a href="<?php echo url('change_rtgs_status') ?>'+'/'+id+'/yes'+'" class="btn btn-success" title="Change Status">'+'Yes'+'</a>';    
                                    }
                                    else{
                                   out += '<a href="<?php echo url('change_rtgs_status') ?>'+'/'+id+'/no'+'" class="btn btn-danger" title="Change Status">'+'No'+'</a>';
                                    }
                                }
                                else {
