...
Route::name('admin.')->namespace('Admin')->group(function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::get('/payment_list', 'BankPaymentApprovalController@payment_list')->name('payment_list');
        ...
        Route::get('/cash_payment_list', 'CashApprovalController@cash_payment_list')->name('cash_payment_list');
    ...
    Route::post('/rejectEmpRequest', 'Inward_outwardController@rejectEmpRequest')->name('rejectEmpRequest');
        ...
        Route::get('/online_payment_list', 'OnlinePaymentApprovalController@online_payment_list')->name('online_payment_list');
