...
//StatusUpdateController methods
        ...
        Route::get('/cron_pending_budget_sheet', 'StatusUpdateController@cron_pending_budget_sheet')->name('cron_pending_budget_sheet');
        Route::get('/cron_pending_pre_sign_letter_head', 'StatusUpdateController@cron_pending_pre_sign_letter_head')->name('cron_pending_pre_sign_letter_head');
        Route::get('/cron_pending_letter_head', 'StatusUpdateController@cron_pending_letter_head')->name('cron_pending_letter_head');
...
Route::name('admin.')->namespace('Admin')->group(function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::get('/change_bank_status/{id}/{status}', 'BankController@change_bank_status')->name('change_bank_status');
...
Route::get('/hr_access_request', 'AssetAccessController@hr_access_request')->name('hr_access_request');
        ...
        Route::any('/employee_expense_list', 'EmployeeExpenseController@employee_expense_list')->name('employee_expense_list');
        ...
        Route::post('/reject_all_travel_option','TravelController@reject_all_travel_option')->name('reject_all_travel_option');
         ...
         Route::post('/reject_travel_request','TravelController@reject_travel_request')->name('reject_travel_request');
        ...
        Route::get('/add_bank_payment_detail', 'BankPaymentApprovalController@add_bank_payment_detail')->name('add_bank_payment_detail');
        ...
        Route::post('/get_bank_payment_data', 'BankPaymentApprovalController@get_bank_payment_data')->name('get_bank_payment_data');
		 ...
		 //Route::post('/get_bank_payments','BankPaymentApprovalController@get_bank_payments')->name('get_bank_payments');
		//Route::post('/approve_paymentByAccountant','BankPaymentApprovalController@approve_paymentByAccountant')->name('approve_paymentByAccountant');
...
Route::get('/pending_registry_documents', 'Inward_outwardController@pending_registry_documents')->name('pending_registry_documents');
        ...
        //Route::get('cal', 'GoogleCalenderController@index')->name('cal');
        //Route::get('oauth', 'GoogleCalenderController@oauth')->name('oauth');
        //Route::get('passDatesGoogle', 'EmployeeInsuranceController@passDatesGoogle')->name('passDatesGoogle');
    ...
    Route::get('/edit_selected_tender/{id}', 'TenderController@edit_selected_tender')->name('edit_selected_tender');
      ...
      Route::post('change_financial_file','TenderController@change_financial_file')->name('change_financial_file'); 
          ...
          Route::get('downloadsubpreparetechdoc/{id}','TenderController@downloadsubpreparetechdoc')->name('downloadsubpreparetechdoc');
          ...
          Route::get('downloadsubpreparefinadoc/{id}','TenderController@downloadsubpreparefinadoc')->name('downloadsubpreparefinadoc');
          ...
          Route::get('downloadsubprepareboqdoc/{id}','TenderController@downloadsubprepareboqdoc')->name('downloadsubprepareboqdoc');
          //08/05/2020
    ...
    //06/05/2020
    //methods of DeliveryModeController
 ...
 //19/05/2020
    ...
    Route::get('/bank_reconciliation','BankReconciliationController@index')->name('bank_reconciliation');
    Route::get('/get_bank_reconciliation_list','BankReconciliationController@get_bank_reconciliation_list')->name('get_bank_reconciliation_list');
    Route::get('/add_bank_reconciliation','BankReconciliationController@add_bank_reconciliation')->name('add_bank_reconciliation');
    Route::post('/get_company_bank_list','BankReconciliationController@get_company_bank_list')->name('get_company_bank_list');
    Route::post('/save_bank_reconciliation','BankReconciliationController@save_bank_reconciliation')->name('save_bank_reconciliation');
});
