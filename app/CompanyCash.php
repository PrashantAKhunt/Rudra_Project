...
class CompanyCash extends Model{
    ...
    public static function get_list_datatable_ajax($table,$datatable_fields, $conditions_array, $getfiled, $request, $join_str = array(),$where_date=[]) {
        ...
        $data = DB::table($table)
            ...
            //---------
            $total_balance = DB::table($table)->sum('company_cash_management.balance');
            $output['total_balance'] = $total_balance;
            //---------
    ...
    public static function get_list_date_range($table, $datatable_fields, $conditions_array, $getfiled, $request, $join_str = array(),$start_date,$end_date){
        $output = array();
        $data = DB::table($table)
            ->select($getfiled);
        ...
        if(!empty($start_date) && !empty($end_date)){
            $data->whereDate($table.'.created_at', '>=', $start_date);
            $data->whereDate($table.'.created_at', '<=', $end_date);
        }
