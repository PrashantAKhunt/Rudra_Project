...
class Inward_outwardController extends Controller
{
    ...
    public function pending_registry_documents()
    {
        ...
        $registry_docs = Inward_outwards::select('department.dept_name','users.name as requested_by','sender.name as sender_type','inward_outward_delivery_mode.name as delivery_mode_name','inward_outward_doc_sub_category.sub_category_name', 'company.company_name', 'project.project_name',
         'inward_outwards.id', 'inward_outwards.document_file', 'inward_outwards.inward_outward_title',
          'inward_outwards.inward_outward_no', 'inward_outwards.parent_inward_outward_no',
           'inward_outwards.description','inward_outwards.ref_outward_number', 'inward_outwards.type',
            'inward_outwards.expected_ans_date', 'inward_outwards.created_at', 'inward_outward_doc_category.category_name',
             'inward_outwards.received_date','inward_outwards.sender_name','inward_outwards.sender_invoice_date','inward_outwards.pdf_page_no',
             'inward_outwards.pdf_size','inward_outwards.doc_allotment_time','inward_outwards.doc_delivery_mode','inward_outwards.delivery_file','inward_outwards.sender_comment')
    ...
    public function inwards()
    {
        ...
        //-------------------------------------------------
        $partial_query = Inward_outwards::select('inward_outward_doc_sub_category.sub_category_name', 'inward_outwards.id', 'inward_outwards.inward_outward_title', 'inward_outwards.inward_outward_no', 'inward_outwards.parent_inward_outward_no', 'inward_outwards.description', 'inward_outwards.type', 'inward_outwards.expected_ans_date', 'inward_outwards.created_at', 'inward_outward_doc_category.category_name', 'inward_outwards.received_date')
                ->join('inward_outward_doc_category', 'inward_outward_doc_category.id', '=', 'inward_outwards.doc_category_id')
                ->leftJoin('inward_outward_users', 'inward_outward_users.inward_outward_id', '=', 'inward_outwards.id')
                ->leftJoin('inward_outward_doc_sub_category', 'inward_outward_doc_sub_category.id', '=', 'inward_outwards.doc_sub_category_id')
                ->where('inward_outwards.type', '=', 'Inwards')
    ...
    public function outwards()
    {
        ...
        $this->data['module_title'] = "Inward Outward ";
        $partial_query = Inward_outwards::select('inward_outward_doc_sub_category.sub_category_name', 'inward_outwards.id', 'inward_outwards.inward_outward_title', 'inward_outwards.inward_outward_no', 'inward_outwards.description', 'inward_outwards.parent_inward_outward_no', 'inward_outwards.type', 'inward_outwards.expected_ans_date', 'inward_outwards.created_at', 'inward_outward_doc_category.category_name', 'inward_outwards.received_date')
                ->join('inward_outward_doc_category', 'inward_outward_doc_category.id', '=', 'inward_outwards.doc_category_id')
                ->leftJoin('inward_outward_doc_sub_category', 'inward_outward_doc_sub_category.id', '=', 'inward_outwards.doc_sub_category_id')
                ->join('inward_outward_users', 'inward_outward_users.inward_outward_id', '=', 'inward_outwards.id')
                ->where('inward_outwards.type', '=', 'Outwards')
        ...
        return view('admin.user.outwards', $this->data, ['outward_list' => $list]);
    }
    ...
    public function view_inward_to_outward($id)
    {
        $this->data['page_title'] = "View Inward";
        $this->data['module_title'] = "Inwards";

        $inward_select_fields = ['inward_outward_delivery_mode.name as delivery_mode_name','sender.name as sender_type','inward_outwards.sender_comment',
            ...
            ,'prime_user.name as prime_username'
        ];
    ...
    public function prelimary_action_list()
    {
        ...
        $this->data['process_list'] = Inward_outwards::leftjoin('users', 'users.id', '=', 'inward_outwards.prime_employee_id')
                                        ...
                                        ->where('inward_outward_users.user_id', Auth::user()->id)
                                        ->whereDate('inward_outwards.created_at','>=','2020-06-02')
                                        ->get(['inward_outwards.inward_outward_no','users.name as prime_employee_name','inward_outwards.prime_user_status','inward_outwards.reject_reason','inward_outwards.id', 'department.dept_name','inward_outwards.expected_ans_date','inward_outwards.querry_details']);
    ...
    public function prime_action_list()
    {
                ...
                ->with(['emp_distrubution' => function($query){
                    $query->leftjoin('users', 'users.id','=','inward_outward_distrubuted_work.support_employee_id')
                        ...
                        ->select(['inward_outward_prime_action_id','support_department_id','support_employee_id','users.name','task_percentage','task_hour','inward_outward_distrubuted_work.work_hour','emp_status',\DB::raw("GROUP_CONCAT(department.dept_name) as depart_name")]); }]) 
                                        ...
                                        ->where('inward_outwards.prime_employee_id', Auth::user()->id)
                                        ->whereDate('inward_outwards.created_at','>=','2020-06-02')
                                        ->get(['inward_outwards.id as inward_id','inward_outwards.inward_outward_no','inward_outwards.prime_user_status',
                                            'inward_outward_prime_action.*','inward_outward_prime_action.assume_work_type',
                                             ...
                                             'inward_outward_prime_action.work_details']);
        ...
        $this->data['requests_list'] = $request_list = Inward_outward_distrubuted_work::join('inward_outward_prime_action','inward_outward_prime_action.id','=','inward_outward_distrubuted_work.inward_outward_prime_action_id')
                ...
                ->whereDate('inward_outwards.created_at','>=','2020-06-02')
                ->get(['users.name as prime_user','inward_outward_distrubuted_work.id','inward_outwards.inward_outward_no',
                ...
                'inward_outward_prime_action.work_details','inward_outward_distrubuted_work.reliever_dates','inward_outward_distrubuted_work.reliever_user_id']);
    ...
    public function accept_requestByPrimeUser($id, Request $request) {  //nish
    ...
    public function accept_requestBySupportEmp($id, Request $request) {  //nish
    ...
    public function acceptEmpRequest($id, Request $request) {  //nish   //mouse
    ...
    public function rejectEmpRequest(Request $request) {    //mouse
    ...
    public function removeEmp($id, Request $request) {  //nish    //mouse
    ...
    public function reject_distrubutionPrimeUser(Request $request) {   // not in use
    ...
    public function distrubuted_llist($id)
    {
         ...
         $this->data['distrubuted_llist'] = $distrubuted_llist = Inward_outward_distrubuted_work::join('users','users.id','=','inward_outward_distrubuted_work.support_employee_id')
                            ...
                            ->get(['users.name','B.name as reject_user_name','inward_outward_prime_action.reject_reason','inward_outward_prime_action.assume_total_hour','inward_outward_distrubuted_work.id','inward_outward_distrubuted_work.inward_outward_prime_action_id','inward_outward_distrubuted_work.support_employee_id',
    ...
    public function accept_emp_work($id, Request $request) {  //nish
