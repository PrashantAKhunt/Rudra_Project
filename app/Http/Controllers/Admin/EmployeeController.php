...
class EmployeeController extends Controller
{
    ...
    public function employee_salary_list() {
        ...
        $datatable_fields = array('users.name','employee_salary.basic_salary','employee_salary.hra','employee_salary.other_allowance','employee_salary.salary_month','employee_salary.salary_year','employee_salary.total_month_salary','employee_salary.id');
        $request = Input::all();
        

        $getfiled = array('users.name','employee_salary.basic_salary','employee_salary.hra','employee_salary.other_allowance','employee_salary.salary_month','employee_salary.salary_year','employee_salary.total_month_salary','employee_salary.id');
    ...
    public function insert_employee_salary(Request $request) {
        ...
        $employeeModel->total_month_salary = (int)$request->input('basic_salary')+(int)$request->input('hra')+(int)$request->input('other_allowance');
        $employeeModel->created_at = date('Y-m-d h:i:s');
        $employeeModel->created_ip = $request->ip();
        $employeeModel->updated_at = date('Y-m-d h:i:s');
        $employeeModel->updated_ip = $request->ip();
    ...
    public function update_employee_salary(Request $request) {
        ...
        $employee_arr = [
            ...
            'total_month_salary' => (int)$request->input('basic_salary')+(int)$request->input('hra')+(int)$request->input('other_allowance'),
