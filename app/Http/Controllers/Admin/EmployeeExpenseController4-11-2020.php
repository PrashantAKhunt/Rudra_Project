...
class EmployeeExpenseController extends Controller
{
    ...
    public function add_employee_expense()
    {
        ...
        $this->data['Expense_List'] = Expense_category::select('id', 'category_name')->get();
    ...
    public function employee_expense_list()
    {   //this
    ...
    public function all_employee_expense_list_ajax() {   //this
        ...
        'employee_expense.expense_date','employee_expense.expense_image',
        ...
        'employee_expense.first_approval_status','employee_expense.second_approval_status',
        'employee_expense.third_approval_status','employee_expense.forth_approval_status',
        'employee_expense.fifth_approval_status','employee_expense.status',
        'acc_users.name');
